...
OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.d

2_Out/Gnuc/0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.o: 0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '
...
OBJ_FILES_MAIN+= 2_Out/Gnuc/0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_QSPI.o
DEP_FILES_MAIN+= 2_Out/Gnuc/0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_QSPI.d

2_Out/Gnuc/0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_QSPI.o: 0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_QSPI.c 1_ToolEnv/0_Build/1_Config/CfgCompiler_Gnuc.mk
	@mkdir -p $(@D)
	@rm -f $(ELF_BIN_MAIN) $(ADDITIONAL_EXE_MAIN) $(MAP_FILE_MAIN) $(LIB_OBJ_MAIN)
	@echo 'Compiling 0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_QSPI.c'
	$(CC) $(CC_OPTS) @1_ToolEnv/0_Build/9_Make/cIncludePathList.opt -c $< -o $@ -save-temps=obj -MMD
	@echo ' '
