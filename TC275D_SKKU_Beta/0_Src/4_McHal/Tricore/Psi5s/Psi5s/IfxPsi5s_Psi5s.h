...
typedef struct
{
    const IfxPsi5s_Rx_In   *rx;            /**< \brief PSI5S Rx pin */
    IfxPort_InputMode       rxMode;        /**< \brief Rx pin as input */
    const IfxPsi5s_Tx_Out  *tx;            /**< \brief PSI5S Tx pin */
    IfxPort_OutputMode      txMode;        /**< \brief Tx as output */
    const IfxPsi5s_Clk_Out *clk;           /**< \brief PSI5S Clk Pin */
...
typedef struct
{
    const IfxPsi5s_Psi5s          *module;                 /**< \brief Specifies pointer to the IfxPsi5s_Psi5s module handle */
...
typedef struct
{
    ...
    const IfxPsi5s_Psi5s_Pins         *pins;                    /**< \brief structure for PSI5S pin configuration */
