 ...
 *
 * \defgroup IfxLld_Iom_Iom IOM
 * \ingroup IfxLld_Iom
 * \defgroup IfxLld_Iom_Iom_Structures Data Structures
 * \ingroup IfxLld_Iom_Iom
 * \defgroup IfxLld_Iom_Iom_Module Module Functions
 * \ingroup IfxLld_Iom_Iom
 * \defgroup IfxLld_Iom_Iom_Operative Operative Functions
 * \ingroup IfxLld_Iom_Iom
 */
...
/** \addtogroup IfxLld_Iom_Iom_Structures
 * \{ */
...
/** \addtogroup IfxLld_Iom_Iom_Module
 * \{ */
...
/** \addtogroup IfxLld_Iom_Iom_Operative
 * \{ */
