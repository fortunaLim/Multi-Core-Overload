...
typedef struct
{
    ...
    const IfxCif_Cam_JpegTables *jpegTables;                         /**< \brief jpeg tables */
...
typedef struct
{
    const IfxCif_Cam_Common      *common;             /**< \brief pointer to common configuration */
    ...
    const uint32                 *setupDataTable;     /**< \brief pointer to the first entry of camera-specific configuration data */
    const IfxCif_Cam_Downscaling *downscaling;        /**< \brief downscaling settings for ExtraPath 1 */
} IfxCif_Cam_Config;
 ...
 * \param z Extra path
 */
IFX_INLINE const IfxCif_Cam_MemInfo *IfxCif_Cam_getExtraPathMemInfo(const IfxCif_Cam *cam, IfxCif_ExtraPath z);
 ...
 *     return m;
 */
IFX_INLINE const IfxCif_Cam_MemInfo *IfxCif_Cam_getLastExtraCaptureInfo(const IfxCif_Cam *cam, IfxCif_ExtraPath z, Ifx_AddressValue *address, uint32 *size);
 ...
 * \param size Size
 */
IFX_INLINE const IfxCif_Cam_MemInfo *IfxCif_Cam_getLastFrameCaptureInfo(const IfxCif_Cam *cam, Ifx_AddressValue *address, uint32 *size);
 ...
 */
IFX_EXTERN const IfxCif_Cam_PictureInfo *IfxCif_Cam_getExtraPathPictureInfo(const IfxCif_Cam *cam, IfxCif_ExtraPath z);
