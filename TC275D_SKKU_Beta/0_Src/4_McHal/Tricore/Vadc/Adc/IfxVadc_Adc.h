...
typedef struct
{
    ...
    IfxScuCcu_AdcClockSelection converterClock;                                        /**< \brief Specifies the ADC converter clock in SCU_CCUCON0.B.ADCCLKSEL */
...
/** \brief Soft  calibration to improve VADC performance
 * \param groupId specifies Group ID
 * \return None
 */
