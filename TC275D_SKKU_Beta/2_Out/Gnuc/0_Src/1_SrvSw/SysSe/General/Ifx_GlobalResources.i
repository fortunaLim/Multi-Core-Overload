...
{
    sint32 id = -1;
# 82 "0_Src/1_SrvSw/SysSe/General/Ifx_GlobalResources.c"
    return id;
}
...
# 102 "0_Src/1_SrvSw/SysSe/General/Ifx_GlobalResources.c"
    result = ((void *)0);
...
{
    pchar name;
# 126 "0_Src/1_SrvSw/SysSe/General/Ifx_GlobalResources.c"
    name = "unknown";
