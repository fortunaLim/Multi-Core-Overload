...
extern const Ifx_Shell_Command *Ifx_Shell_commandFind(const Ifx_Shell_Command *commandList, pchar commandLine, pchar *args);
...
# 340 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.h"
...
void Ifx_Shell_process(Ifx_Shell *shell)
{
    ...
    {
# 298 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c"
        count = 0;
        readCount = (128) - count;
...
# 928 "0_Src/1_SrvSw/SysSe/Comm/Ifx_Shell.c"
void Ifx_Shell_cmdEscapeProcess(Ifx_Shell *shell, char EscapeChar1, char EscapeChar2)
{
