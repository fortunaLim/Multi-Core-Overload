# 1 "0_Src/0_AppSw/Tricore/System/UserInterface/GUI.c"
# 1 "C:\\Users\\tpwjd\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/System/UserInterface/GUI.c"
# 1 "0_Src/0_AppSw/Tricore/System/UserInterface/GUI.h" 1
...
# 2 "0_Src/0_AppSw/Tricore/System/UserInterface/GUI.h" 2
# 1 "./0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_GUI.h" 1
# 25 "./0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_GUI.h"
typedef struct Rect
{
 int x1, y1, x2, y2;
 int width, height;
...
extern void GUI_DrawRect(pRect rect, unsigned int color );
extern void GUI_DrawRect_full(pRect rect, unsigned int color , unsigned int color_in);

extern void GUI_formatBT(pBT BT);
extern void GUI_h_formatBT(pBT BT, int check);

extern void GUI_setGraphInitialize(pGRAPH GP, int target);
extern void GUI_setGraphValue(pGRAPH GP, int value, int target);
extern void GUI_setGraphClear(pGRAPH GP);

extern void GUI_Delay (unsigned int nCount);
extern int _abs(int x);
extern void GUI_Button(int x1, int y1, int x2, int y2, unsigned int color , unsigned int color_in, unsigned char *str, unsigned int tcolor);
extern int GUI_xyRead(int Current_x, int Current_y, pRect rect);

extern int GUI_InputProcessing(int x, int y, int CurrentPageState);
extern int GUI_InputProcessing_down(int x, int y, int CurrentPageState);

extern void GUI_set_Location(int loc);
extern int GUI_get_Location(void);
# 3 "0_Src/0_AppSw/Tricore/System/UserInterface/GUI.h" 2
# 20 "0_Src/0_AppSw/Tricore/System/UserInterface/GUI.h"
...
extern void GUI_Grpaph(int value, int target);
extern void IO_run_TFTLCD(void);
# 2 "0_Src/0_AppSw/Tricore/System/UserInterface/GUI.c" 2
...
# 14 "./0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.h"
...
# 3 "0_Src/0_AppSw/Tricore/System/UserInterface/GUI.c" 2
...
pBT _Home(int x, int y)
{
 Home.rect.width = 50;
 Home.rect.height = 25;
 Home.rect.x1 = x; Home.rect.y1 = y;
 Home.rect.x2 = x + Home.rect.width; Home.rect.y2 = y + Home.rect.height;
 Home.button_color = 0xFFFF; Home.guide_color = 0xFFFF;
 Home.name = "Home"; Home.name_color = 0x001F;
 Home.h_guide_color = 0xFFE0;
...
pBT _Menu1(int x, int y)
{
 ...
 Menu1.button_color = 0x001F; Menu1.guide_color = 0xFFFF;
 Menu1.name = "Menu1"; Menu1.name_color = 0xFFFF;
 Menu1.h_guide_color = 0xFFE0;
...
pBT _Menu2(int x, int y)
{
 ...
 Menu2.button_color = 0x001F; Menu2.guide_color = 0xFFFF;
 Menu2.name = "Menu2"; Menu2.name_color = 0xFFFF;
 Menu2.h_guide_color = 0xFFE0;
...
pBT _Menu3(int x, int y)
{
 ...
 Menu3.button_color = 0x001F; Menu3.guide_color = 0xFFFF;
 Menu3.name = "Menu3"; Menu3.name_color = 0xFFFF;
 Menu3.h_guide_color = 0xFFE0;
...
pBT _M1sub1(int x, int y)
{
 ...
 M1sub1.button_color = 0x001F; M1sub1.guide_color = 0xFFFF;
 M1sub1.name = "M1sub1"; M1sub1.name_color = 0xFFFF;
 M1sub1.h_guide_color = 0xFFE0;
...
pBT _M1sub2(int x, int y)
{
 ...
 M1sub2.button_color = 0x001F; M1sub2.guide_color = 0xFFFF;
 M1sub2.name = "M1sub2"; M1sub2.name_color = 0xFFFF;
 M1sub2.h_guide_color = 0xFFE0;
...
pBT _M3sub1(int x, int y)
{
 ...
 M3sub1.button_color = 0x001F; M3sub1.guide_color = 0xFFFF;
 M3sub1.name = "M3sub1"; M3sub1.name_color = 0xFFFF;
 M3sub1.h_guide_color = 0xFFE0;
...
pBT _LED1(int x, int y)
{
 ...
 LED1.button_color = 0x001F; LED1.guide_color = 0xFFFF;
 LED1.name = "LED1"; LED1.name_color = 0xFFFF;
 LED1.h_guide_color = 0xFFE0;
...
pBT _LED2(int x, int y)
{
 ...
 LED2.button_color = 0x001F; LED2.guide_color = 0xFFFF;
 LED2.name = "LED2"; LED2.name_color = 0xFFFF;
 LED2.h_guide_color = 0xFFE0;
...
pBT _LED3(int x, int y)
{
 ...
 LED3.button_color = 0x001F; LED3.guide_color = 0xFFFF;
 LED3.name = "LED3"; LED3.name_color = 0xFFFF;
 LED3.h_guide_color = 0xFFE0;
...
pBT _LED4(int x, int y)
{
 ...
 LED4.button_color = 0x001F; LED4.guide_color = 0xFFFF;
 LED4.name = "LED4"; LED4.name_color = 0xFFFF;
 LED4.h_guide_color = 0xFFE0;
...
pGRAPH _Graph(int x, int y)
{
 ...
 Graph.guide_color = 0xFFFF; Graph.line_color = 0xFFFF;
 Graph.name_color = 0xFFFF; Graph.value_color = 0xFFFF;
 Graph.inside_color = 0x0000; Graph.mark_color = 0xF800;
...
int page_App_CHAT(void)
{
 ...
 GUI_DrawRect(msgBox, 0xFFFF);
 IO_LCD_GUI_DrawLine(5,205,315,205,0xFFFF);

 IO_LCD_GUI_Text(20,212,"Type a message here",0x7BE0,0x0000);


 GUI_set_Location(311);
 return 311;
}
...
int page_App_Bar_graphB(void)
{
 ...
 GUI_DrawRect(barGraphBox, 0xFFFF);

 IO_LCD_GUI_Text(20, 70, "Sens1", 0xFFFF, 0x0000);
 IO_LCD_GUI_Text(20, 110, "Sens2", 0xFFFF, 0x0000);
 IO_LCD_GUI_Text(20, 150, "Sens3", 0xFFFF, 0x0000);
 IO_LCD_GUI_Text(20, 190, "Sens4", 0xFFFF, 0x0000);

 Bar_Graph3(12.34, 12.34, 12.34, 12.34);


 GUI_set_Location(321);
 return 321;
}
...
void Bar_Graph3(float val1, float val2, float val3, float val4)
{
 ...
 barGraphbar1.y1 = 60;
 barGraphbar1.y2 = 90;
 GUI_DrawRect_full(barGraphbar1, 0x0000, 0x001F);
 ...
 barGraphbar2.y1 = 100;
 barGraphbar2.y2 = 130;
 GUI_DrawRect_full(barGraphbar2, 0x0000, 0x001F);
 ...
 barGraphbar3.y1 = 140;
 barGraphbar3.y2 = 170;
 GUI_DrawRect_full(barGraphbar3, 0x0000, 0x001F);
 ...
 barGraphbar4.y1 = 180;
 barGraphbar4.y2 = 210;
 GUI_DrawRect_full(barGraphbar4, 0x0000, 0x001F);
 ...
 barGraphbar1_.y1 = 60;
 barGraphbar1_.y2 = 90;
 GUI_DrawRect_full(barGraphbar1_, 0x0000, 0x0000);
 ...
 GUI_DrawRect_full(barGraphbar2_, 0x0000, 0x0000);
 ...
 GUI_DrawRect_full(barGraphbar3_, 0x0000, 0x0000);
 ...
 GUI_DrawRect_full(barGraphbar4_, 0x0000, 0x0000);
 ...
 IO_LCD_GUI_Text(220, 70, bar_val[0], 0xFFFF, 0x0000);
 IO_LCD_GUI_Text(220, 110, bar_val[1], 0xFFFF, 0x0000);
 IO_LCD_GUI_Text(220, 150, bar_val[2], 0xFFFF, 0x0000);
 IO_LCD_GUI_Text(220, 190, bar_val[3], 0xFFFF, 0x0000);
...
void IndicatorBar(unsigned char *str)
{
 ...
 GUI_DrawRect_full(rect, 0x001F, 0x001F);


 IO_LCD_GUI_Text(5,5, str, 0xFFFF, 0x001F);
...
int page_test(void)
{
 ...
 text[15] = 0;
 text[16] = 0;
 IO_LCD_GUI_Text(point_x, point_y, text, 0xFFFF, 0x0000);
 text[15] = '\r';
 text[16] = '\n';
 printf(text);

 GUI_set_Location(999);
 return 999;
}
