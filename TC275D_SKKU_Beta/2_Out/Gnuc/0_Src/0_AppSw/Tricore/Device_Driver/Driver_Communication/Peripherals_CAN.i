# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c"
# 13 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c"
...
# 14 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c" 2
...
# 15 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c" 2
...
# 16 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c" 2
...
# 45 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\tricore\\include\\stdio.h" 3
...
# 17 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c" 2
# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.h" 1
# 13 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.h"
...
# 14 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.h" 2
...
# 15 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.h" 2
...
# 18 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c" 2
...
# 19 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c" 2
...
# 20 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c" 2
...
static uint8 LDO[4];
# 56 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c"
      ...
      uint8 size_frame, uint8 FD_on)
{
    ...
    canMsgObjConfig.msgObjId = num_msgObj;
   ...
   canMsgObjConfig.control.extendedFrame = 0;
    }
    else
    {
     if(size_frame <= 12)
   ...
   canMsgObjConfig.control.extendedFrame = 1;
      canMsgObjConfig.control.topMsgObjId = 160+num_msgObj;
      canMsgObjConfig.control.bottomMsgObjId = 180+num_msgObj;
    }

    canMsgObjConfig.acceptanceMask = 0x7FFFFFFFUL;
 canMsgObjConfig.control.matchingId = 1;
    canMsgObjConfig.control.fastBitRate = FD_on;
...
void Set_CAN_Rx(uint8 num_msgObj, uint8 num_ch, uint32 ID_mask, uint32 ID_accept,
    uint8 Frame_extend, uint8 FD_on, void *isrFuncPointer, uint16 priority, uint8 num_core)
{
# 233 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_CAN.c"
 Ifx_SRC_SRCR *srcPointer = &(((*(Ifx_SRC *)0xF0038000u)).CAN.CAN[0].INT[num_msgObj-20]);
 srcPointer->B.SRPN = priority;
 srcPointer->B.TOS = num_core;
 srcPointer->B.CLRR = 1;
 srcPointer->B.SRE = 1;
...
{
    Ifx_CAN_MO *hwObj = &(((*(Ifx_CAN *)0xF0018000u)).MO[number_MsgObj]);
...
void IO_Send_CAN(uint8 number_MsgObj, uint8 *data, uint8 size)
{
 ...
 for(i=0; i<size; i++)
  buffer[i] = data[i];
    ...
    Ifx_CAN_MO *hwObj = &(((*(Ifx_CAN *)0xF0018000u)).MO[number_MsgObj]);
    Ifx_CAN_MO *hwtopObj = &(((*(Ifx_CAN *)0xF0018000u)).MO[160+number_MsgObj]);
    Ifx_CAN_MO *hwbotObj = &(((*(Ifx_CAN *)0xF0018000u)).MO[180+number_MsgObj]);
...
uint32 Get_CAN_RxBuffer(uint8 num_MsgObj, uint8 *buffer)
{
    ...
    Ifx_CAN_MO *hwObj = &(((*(Ifx_CAN *)0xF0018000u)).MO[num_MsgObj]);
    Ifx_CAN_MO *hwtopObj = &(((*(Ifx_CAN *)0xF0018000u)).MO[180+num_MsgObj]);
    Ifx_CAN_MO *hwbotObj = &(((*(Ifx_CAN *)0xF0018000u)).MO[200+num_MsgObj]);
