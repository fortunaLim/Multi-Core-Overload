# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c"
...
# 9 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c" 2
# 1 "./0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Peripherals.h" 1
# 10 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c" 2
...
# 11 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c" 2
# 1 "./0_Src/0_AppSw/Tricore/Device_Driver/Driver_System/SysCFG_Cores.h" 1
# 19 "./0_Src/0_AppSw/Tricore/Device_Driver/Driver_System/SysCFG_Cores.h"
# 1 "./0_Src/4_McHal/Tricore/Cpu/Irq/IfxCpu_Irq.h" 1
...
# 12 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c" 2
...
# 13 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c" 2
...
# 14 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c" 2
...
# 15 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c" 2
# 23 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c"
...
void asclin0RxISR(void)
{
 ...
 Ifx_SizeT count = 1;
 IfxAsclin_Asc_read(&pUART_SysLog.drivers.asc0, rxData, &count, ((Ifx_TickTime)0x7FFFFFFFFFFFFFFFLL));
...
void Set_UART_SysLog(void)
{
    ...
    ascConfig.interrupt.txPriority = 64;
    ascConfig.interrupt.rxPriority = 68;
    ascConfig.interrupt.erPriority = 72;
    ...
    IfxCpu_Irq_installInterruptHandler(asclin0TxISR, 64);
    IfxCpu_Irq_installInterruptHandler(asclin0RxISR, 68);
    IfxCpu_Irq_installInterruptHandler(asclin0ErISR, 72);
...
void printf_UART_SysLog(char *buffer, int length)
{
 ...
 IfxAsclin_Asc_write(&pUART_SysLog.drivers.asc0, buffer, &length, ((Ifx_TickTime)0x7FFFFFFFFFFFFFFFLL));


 delay_tic(length);
}
# 159 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c"
...
void asclin1RxISR(void)
{
 ...
 Ifx_SizeT count = 1;
 IfxAsclin_Asc_read(&pUART_WiFi.drivers.asc0, rxData, &count, ((Ifx_TickTime)0x7FFFFFFFFFFFFFFFLL));
...
void Set_UART_WiFi(void)
{
    ...
    IfxAsclin_Asc_Config ascConfig;
    IfxAsclin_Asc_initModuleConfig(&ascConfig, &((*(Ifx_ASCLIN *)0xF0000700u)));
    ...
    ascConfig.interrupt.txPriority = 8;
    ascConfig.interrupt.rxPriority = 9;
    ascConfig.interrupt.erPriority = 73;

    ascConfig.interrupt.typeOfService = IfxSrc_Tos_cpu1;





    IfxCpu_Irq_installInterruptHandler(asclin1TxISR, 8);
    IfxCpu_Irq_installInterruptHandler(asclin1RxISR, 9);
    IfxCpu_Irq_installInterruptHandler(asclin1ErISR, 73);
    ...
    {
        ((void *)0), IfxPort_InputMode_pullUp,
        &IfxAsclin1_RXD_P14_8_IN, IfxPort_InputMode_pullUp,
        ((void *)0), IfxPort_OutputMode_pushPull,
        &IfxAsclin1_TX_P14_10_OUT, IfxPort_OutputMode_pushPull,
        IfxPort_PadDriver_cmosAutomotiveSpeed1
    };
    ascConfig.pins = &pins;
...
void printf_UART_WiFi(char *fmt, ...)
{
 ...
 IfxAsclin_Asc_write(&pUART_WiFi.drivers.asc0, buffer, &length, ((Ifx_TickTime)0x7FFFFFFFFFFFFFFFLL));


 delay_tic(length*100);
}
# 383 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c"
...
void asclin3RxISR(void)
{
 ...
 Ifx_SizeT count = 1;
 IfxAsclin_Asc_read(&pUART_dxl.drivers.asc0, rxData_dxl, &count, ((Ifx_TickTime)0x7FFFFFFFFFFFFFFFLL));
...
void Set_UART_dxl(void)
{
    ...
    ascConfig.interrupt.txPriority = 67;
    ascConfig.interrupt.rxPriority = 71;
    ascConfig.interrupt.erPriority = 75;
    ...
    IfxCpu_Irq_installInterruptHandler(asclin3TxISR, 67);
    IfxCpu_Irq_installInterruptHandler(asclin3RxISR, 71);
    IfxCpu_Irq_installInterruptHandler(asclin3ErISR, 75);
    ...
    const IfxAsclin_Asc_Pins pins =
    {
        ...
        ((void *)0), IfxPort_OutputMode_pushPull,
        &IfxAsclin3_TX_P32_3_OUT, IfxPort_OutputMode_pushPull,
        IfxPort_PadDriver_cmosAutomotiveSpeed1
    };
    ascConfig.pins = &pins;
...
void printf_UART_dxl(char data)
{
 ...
 temp[0] = data;
 Ifx_SizeT count = 1;
 IfxAsclin_Asc_write(&pUART_dxl.drivers.asc0, temp, &count, ((Ifx_TickTime)0x7FFFFFFFFFFFFFFFLL));
}
# 525 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_UART.c"
__inline void delay_UART(unsigned int tic)
{
