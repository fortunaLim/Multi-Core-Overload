# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.c"
# 1 "C:\\Users\\sh970\\tc275_work\\EX1\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.c"
# 13 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.c"
...
# 14 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.c" 2
# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.h" 1
# 16 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.h"
...
# 17 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.h" 2
...
# 18 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.h" 2
...
# 19 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.h" 2
...
# 15 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.c" 2
...
# 16 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.c" 2
...
# 18 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.c" 2
...
# 20 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.c" 2

# 1 "./0_Src/0_AppSw/Config/Common/stdarg.h" 1
# 102 "./0_Src/0_AppSw/Config/Common/stdarg.h"
typedef __gnuc_va_list va_list;
# 22 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ETH.c" 2
...
App_Eth g_Eth;
uint32 __attribute__ ((aligned(64))) memoryDestination[1024];
...
const uint8 SRC_myMacAddress[6] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55};
const uint8 DES_myMacAddress[6] = {0x68, 0x05, 0xCA, 0x86, 0xFA, 0x07};
...
void setPort_ETH(void)
{
    ...
    IfxCpu_Irq_installInterruptHandler(EthISR, 7);

 volatile Ifx_SRC_SRCR *srcr;

 srcr = &((*(Ifx_SRC *)0xF0038000u)).ETH.ETH[0].SR;
 srcr->B.SRPN = 7;
 srcr->B.TOS = IfxSrc_Tos_cpu1;
 srcr->B.CLRR = 1;
 srcr->B.SRE = 1;

 IfxEth_Config config;

 IfxEth_initConfig(&config, &((*(Ifx_ETH *)0xF001D000u)));
...
void EthISR(void)
{
 ...
 if(IfxEth_isRxInterrupt(&g_Eth.drivers.eth) == 1)
 {
...
void printf_ETH(uint8 *SRC_MAC, uint8 *DES_MAC, uint8 *ETH_TYPE, char *fmt, ...)
{
 ...
 memcpy((pTxBuf+14),buffer,(size));
    ...
    while (IfxEth_isTxInterrupt(&g_Eth.drivers.eth) == 0);
}
