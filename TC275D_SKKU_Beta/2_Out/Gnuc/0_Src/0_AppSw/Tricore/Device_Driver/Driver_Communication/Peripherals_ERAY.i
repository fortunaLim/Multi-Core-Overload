# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c"
# 1 "C:\\Users\\tpwjd\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c"
# 12 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c"
...
# 13 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c" 2
...
# 14 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c" 2
# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.h" 1
# 13 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.h"
...
# 14 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.h" 2
...
# 16 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.h" 2
...
# 15 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c" 2
 ...
 void Print_Flexray(App_Eray *eray_pointer, uint32 *data, uint8 buffer_ID)
{
 IfxEray_Eray_writeData(&eray_pointer->eray, data , 2 * 4);
    ...
    config.headerTransfered = 0;
    config.dataTransfered = 1;
    config.transferRequested = 1;
...
void ERAY_irqNdat1Handler(void)
{
# 174 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c"
}
# 184 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c"
void setPort_ERAY(void)
{
    ...
    IfxEray_Eray_initModuleConfig(&pERAY.erayModuleConfig, &((*(Ifx_ERAY *)0xF001C000u)));


    pERAY.erayModuleConfig.interrupt.int0Priority = 30;
    pERAY.erayModuleConfig.interrupt.int1Priority = 31;
    pERAY.erayModuleConfig.interrupt.ndat1Priority = 32;
    pERAY.erayModuleConfig.interrupt.int0IsrProvider = IfxSrc_Tos_cpu0;
    ...
    IfxCpu_Irq_installInterruptHandler(ERAY_irqInt0Handler, 30);
    IfxCpu_Irq_installInterruptHandler(ERAY_irqInt1Handler, 31);
    IfxCpu_Irq_installInterruptHandler(ERAY_irqNdat1Handler, 32);
# 242 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c"
    pERAY.nodeConfig.messageRAMConfig.firstDynamicBuffer = 0x80;
    pERAY.nodeConfig.messageRAMConfig.fifoBufferStartIndex = 0x80;
# 377 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c"
    const IfxEray_Eray_NodeA nodeAPins = {
...
# 435 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_Communication/Peripherals_ERAY.c"
