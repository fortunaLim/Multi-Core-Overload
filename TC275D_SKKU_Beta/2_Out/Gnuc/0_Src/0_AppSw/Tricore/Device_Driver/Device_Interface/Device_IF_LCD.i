# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_LCD.c"
# 1 "C:\\Users\\tpwjd\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_LCD.c"
# 9 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_LCD.c"
...
# 10 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_LCD.c" 2
...
void IO_LCD_Initialize(void)
{
# 149 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_LCD.c"
 f_reset(1);
 Delay_ms_LCD(5);
 f_reset(0);
 Delay_ms_LCD(5);
 ...
 Delay_ms_LCD(5);
 f_BLCNT(1);
# 177 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_LCD.c"
 LCD_Code = 1;
 IO_LCD_writeWord_Register(0x00e7,0x0010);
 IO_LCD_writeWord_Register(0x0000,0x0001);

 IO_LCD_writeWord_Register(0x0001,(0<<10)|(1<<8));

 IO_LCD_writeWord_Register(0x0002,0x0700);
 ...
 IO_LCD_writeWord_Register(0x000a,0x0000);
 IO_LCD_writeWord_Register(0x000c,0x0001);
...
void IO_LCD_setCursor(unsigned int Xpos, unsigned int Ypos)
{
 ...
 unsigned int temp;
# 424 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_LCD.c"
  temp = Ypos;
  Ypos = Xpos;
  Xpos = 240 - 1 - temp;
...
void IO_LCD_GUI_DrawCross(unsigned int Xpos, unsigned int Ypos)
{
 ...
 IO_LCD_GUI_DrawLine(Xpos-15,Ypos+15,Xpos-7,Ypos+15,(int) (((184 >> 3) << 11) | ((158 >> 2) << 5) | (131 >> 3)));
 IO_LCD_GUI_DrawLine(Xpos-15,Ypos+7,Xpos-15,Ypos+15,(int) (((184 >> 3) << 11) | ((158 >> 2) << 5) | (131 >> 3)));

 IO_LCD_GUI_DrawLine(Xpos-15,Ypos-15,Xpos-7,Ypos-15,(int) (((184 >> 3) << 11) | ((158 >> 2) << 5) | (131 >> 3)));
 IO_LCD_GUI_DrawLine(Xpos-15,Ypos-7,Xpos-15,Ypos-15,(int) (((184 >> 3) << 11) | ((158 >> 2) << 5) | (131 >> 3)));

 IO_LCD_GUI_DrawLine(Xpos+7,Ypos+15,Xpos+15,Ypos+15,(int) (((184 >> 3) << 11) | ((158 >> 2) << 5) | (131 >> 3)));
 IO_LCD_GUI_DrawLine(Xpos+15,Ypos+7,Xpos+15,Ypos+15,(int) (((184 >> 3) << 11) | ((158 >> 2) << 5) | (131 >> 3)));

 IO_LCD_GUI_DrawLine(Xpos+7,Ypos-15,Xpos+15,Ypos-15,(int) (((184 >> 3) << 11) | ((158 >> 2) << 5) | (131 >> 3)));
 IO_LCD_GUI_DrawLine(Xpos+15,Ypos-15,Xpos+15,Ypos-7,(int) (((184 >> 3) << 11) | ((158 >> 2) << 5) | (131 >> 3)));
}
...
void IO_LCD_GUI_Text(unsigned int Xpos, unsigned int Ypos, unsigned char *str, unsigned int Color, unsigned int bkColor)
{
    ...
    {
        TempChar = *str++;
        IO_LCD_GUI_PutChar( Xpos, Ypos, TempChar, Color, bkColor );
