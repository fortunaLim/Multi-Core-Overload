# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_TFT.c"
...
# 3 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_TFT.c" 2
# 11 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_TFT.c"
unsigned int mang_x[3];
unsigned int mang_y[3];
...
# 48 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_TFT.c"
 void Touch_qspi_Config(void)
 {
...
# 63 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_TFT.c"
  Coordinate Read_ADC_Pre(void)
  {
...
# 202 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_TFT.c"
 unsigned int Filter_data_x(unsigned int *data, int n)
 {
  int i, j;
  unsigned int tmp;
...
# 230 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_TFT.c"
 unsigned int Filter_data_y(unsigned int *data, int n)
 {
  int i, j;
  unsigned int tmp;
...
# 258 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_TFT.c"
 Coordinate Read_ADC_Post(void)
 {
   static Coordinate screen;
   Coordinate TPXY;
...
# 404 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_TFT.c"
   setCalibrationMatrix(DisplaySample,ScreenSample,&LCD_matrix_calib );
   IO_LCD_Clear(0x7FFF);
 }
...
# 445 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_TFT.c"
Coordinate Touch_Read_Data_X_Y(void)
{
 Coordinate tmp;
 tmp.x = Read_X();
...
int IO_get_TFT_Point(void)
{
 ...
 if(pressing == 0)
 {
  ...
  display_x = Filter_data_x(m_x, 30);
  display_y = Filter_data_y(m_y, 30);
...
void TP_DrawPoint(unsigned int Xpos,unsigned int Ypos)
{
 IO_LCD_SetPoint(Xpos,Ypos,0x001F);
