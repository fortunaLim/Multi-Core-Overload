# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_CAN.c"
# 1 "C:\\Users\\tpwjd\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_CAN.c"
# 9 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_CAN.c"
...
# 10 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_CAN.c" 2
...
void IO_set_CAN(void)
{
 ...
 IO_set_CAN_BitRate(0, 1000000, 2000000);
 IO_set_CAN_BitTiming(0, 2000, 7500, 8000, 7000, 0);

 IO_set_CAN_BitRate(1, 1000000, 2000000);
 IO_set_CAN_BitTiming(1, 2000, 7500, 8000, 7000, 0);

 IO_set_CAN_BitRate(2, 1000000, 2000000);
 IO_set_CAN_BitTiming(2, 2000, 7500, 8000, 7000, 0);

 IO_set_CAN_BitRate(3, 1000000, 2000000);
 IO_set_CAN_BitTiming(3, 2000, 7500, 8000, 7000, 0);

 IO_set_CAN_Enable(0, 0);
 IO_set_CAN_Enable(1, 0);
 IO_set_CAN_Enable(2, 0);
 IO_set_CAN_Enable(3, 0);

 IO_set_CAN_msgObject(0, 0, 0x01, 8, 0);
 IO_set_CAN_msgObject(1, 1, 0x02, 8, 0);
 IO_set_CAN_msgObject(2, 2, 0x03, 8, 0);
 IO_set_CAN_msgObject(3, 3, 0x04, 8, 0);

 ISR_set_CAN_Rx( 20, 0, 0x00000000, 0xFFFFFFFF, 0, 0,
     ISR_CAN_msgObj_0, 10, 1);

 ISR_set_CAN_Rx( 21, 1, 0x00000000, 0xFFFFFFFF, 0, 0,
     ISR_CAN_msgObj_1, 11, 1);

 ISR_set_CAN_Rx( 22, 2, 0x00000000, 0xFFFFFFFF, 0, 0,
     ISR_CAN_msgObj_2, 12, 1);

 ISR_set_CAN_Rx( 23, 3, 0x00000000, 0xFFFFFFFF, 0, 0,
     ISR_CAN_msgObj_3, 13, 1);

 printf_CAN(0, "%s", "CAN_A OK!");
 printf_CAN(1, "%s", "CAN_B OK!");
 printf_CAN(2, "%s", "CAN_C OK!");
 printf_CAN(3, "%s", "CAN_D OK!");
# 128 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_CAN.c"
 printf_SysLog("Done.\r\n");
         ...
         uint8 nSig, float64 tCycletime, float64 tTimeout)
{
 ...
 IO_set_CAN_msgObject(nObj, nCh, nID, nDLC, 0);
...
pCAN_Msg Send_CAN_DB_msgObject(pCAN_Msg msg)
{
 ...
 for(i_sig = 0; i_sig < n_sig; i_sig++)
 {
  ...
  for(j_sig = 0; j_sig < msg.dSig[i_sig].nLength; j_sig++)
  {
   ...
   iter_sig = msg.dSig[i_sig].pAddr + j_sig;
   n_data = iter_sig / 8;
