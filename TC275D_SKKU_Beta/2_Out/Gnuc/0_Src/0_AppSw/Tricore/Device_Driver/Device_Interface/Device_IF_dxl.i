# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_dxl.c"
...
# 8 "0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_dxl.c" 2
...
void Mode_joint(unsigned char id)
{
 ...
 TX0_char(0xff);
 TX0_char(0x03);
 TX0_char(~(id+0x5+0x3+0x8+0xff+0x03));
}
...
void Turn_one(unsigned char id, float value_angle)
{
 ...
 instruction = 0x03;
 parameter[0][0] = 0x1E;
 parameter[0][2] = (char)((1024.0/300 * value_angle)/256);
 parameter[0][1] = (char)((1024.0/300 * value_angle)-(parameter[0][2]*256));
...
void Turn_Speed_one(unsigned char id, unsigned int value_rpm)
{
 ...
 instruction = 0x03;
 parameter[0][0] = 0x20;
 parameter[0][2] = (value_rpm / 0.111)/256;
 parameter[0][1] = (value_rpm / 0.111)-(parameter[0][2]*256);
...
void Send(void)
{
 ...
 TX0_char(0xff);
 TX0_char(0xFE);
 TX0_char(((length_sub+1)*ID_many)+4);
 TX0_char(0x83);
 TX0_char(instruction);
 TX0_char(length_sub);
 for(i=1; i<=dxl_no; i++)
 ...
 TX0_char(~(0xFE + (((length_sub+1)*ID_many)+4) + 0x83 + instruction + length_sub + parasum));
 delay_ms(30);
}
...
void IO_dxl_Turn_sync_sub(unsigned char id, float value_angle, float value_speed)
{
 ...
 dxl_no++;;
 parameter[dxl_no][0] = id;
 parameter[dxl_no][2] = (char)(((1024.0/300) * value_angle)/256);
 parameter[dxl_no][1] = (char)(((1024.0/300) * value_angle)-(parameter[dxl_no][2]*256));
 parameter[dxl_no][4] = (char)((value_speed/0.111)/256);
 parameter[dxl_no][3] = (char)((value_speed/0.111)-(parameter[dxl_no][4]*256));
 angle[id] = value_angle;
}
...
void Read_Status(unsigned char id, unsigned char menu, unsigned char length_read)
{
 ...
 TX0_char(0x02);
 TX0_char(menu);
 TX0_char(length_read);
 TX0_char(~(id + 0x06 + menu + length_read));
}
