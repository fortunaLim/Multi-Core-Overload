# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.c"
# 9 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.c"
...
# 10 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.c" 2
...
# 11 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.c" 2
# 1 "./0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Peripherals.h" 1
# 12 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.c" 2
# 1 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.h" 1
# 15 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.h"
# 1 "./0_Src/4_McHal/Tricore/Cpu/Std/Ifx_Types.h" 1
# 16 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.h" 2
...
# 17 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.h" 2

# 1 "./0_Src/4_McHal/Tricore/Scu/Std/IfxScuEru.h" 1
# 50 "./0_Src/4_McHal/Tricore/Scu/Std/IfxScuEru.h"
...
extern unsigned char IfxScuEru_getEventFlagStatus(IfxScuEru_InputChannel inputChannel);
...
extern void IfxScuEru_setFlagPatternDetection(IfxScuEru_OutputChannel outputChannel, IfxScuEru_InputChannel inputChannel, unsigned char state);
...
extern unsigned char IfxScuEru_getPatternDetectionResult(IfxScuEru_OutputChannel outputChannel);
...
# 19 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.h" 2
...
extern void ISR_SCUERU_02(void);
extern unsigned int get_USvalue(void);
# 13 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.c" 2
...
# 14 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.c" 2
...
static unsigned int imax_cmp_stm = 50;
...
static unsigned int cmp_stm[50] = {0,};
static unsigned int cmp_stm_f[50] = {0,};
...
void setPort_SCUERU02(void)
{
     ...
     IfxScuEru_setFlagPatternDetection(outputChannel, inputChannel, 1);
     ...
     {
         volatile Ifx_SRC_SRCR *src = &((*(Ifx_SRC *)0xF0038000u)).SCU.SCU.ERU[(int)outputChannel % 4];
         IfxSrc_init(src, IfxSrc_Tos_cpu1, 3);
         IfxSrc_enable(src);
     }


     IfxCpu_Irq_installInterruptHandler(ISR_SCUERU_02, 3);
...
void get_USvalue_Mechanism(void)
{
 ...
 if(cnt_scueru > 5)
 {
  ...
  else if(bSCUERU02_edge == 0)
  {
   ...
   for(i_cmp_stm = 50 - 1; i_cmp_stm > 0; i_cmp_stm--)
   {
   ...
   for(i_cmp_stm = 0; i_cmp_stm < 50; i_cmp_stm++)
   {
   ...
   us_x_temp = 0;
   int cnt_median = 50 - 20;
   for(i_cmp_stm = 20; i_cmp_stm < cnt_median; i_cmp_stm++)
   {
...
# 260 "0_Src/0_AppSw/Tricore/Device_Driver/Driver_IO/Peripherals_SCUERU.c"
...
void setPort_SCUERU22(void)
{
     ...
     IfxScuEru_InputNodePointer triggerSelect = IfxScuEru_InputNodePointer_2;
     IfxScuEru_OutputChannel outputChannel = IfxScuEru_OutputChannel_2;
     ...
     {
         volatile Ifx_SRC_SRCR *src = &((*(Ifx_SRC *)0xF0038000u)).SCU.SCU.ERU[(int)outputChannel % 4];
         IfxSrc_init(src, IfxSrc_Tos_cpu0, 4);
         IfxSrc_enable(src);
     }


     IfxCpu_Irq_installInterruptHandler(ISR_SCUERU_22, 4);
