# 1 "0_Src/0_AppSw/Tricore/Application/Application.c"
# 1 "C:\\Users\\sh970\\tc275_work\\EX1\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/0_AppSw/Tricore/Application/Application.c"
...
# 8 "0_Src/0_AppSw/Tricore/Application/Application.c" 2
...
# 9 "0_Src/0_AppSw/Tricore/Application/Application.c" 2
...
# 10 "0_Src/0_AppSw/Tricore/Application/Application.c" 2
...
# 11 "0_Src/0_AppSw/Tricore/Application/Application.c" 2
...
# 19 "./0_Src/0_AppSw/Tricore/System/Systems/SysCFG_Log.h"
...
# 12 "0_Src/0_AppSw/Tricore/Application/Application.c" 2
# 1 "./0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_ADC.h" 1
# 13 "0_Src/0_AppSw/Tricore/Application/Application.c" 2
...
# 14 "0_Src/0_AppSw/Tricore/Application/Application.c" 2

# 1 "./0_Src/0_AppSw/Tricore/Device_Driver/Device_Interface/Device_IF_PBSW.h" 1
# 16 "0_Src/0_AppSw/Tricore/Application/Application.c" 2
# 1 "./0_Src/0_AppSw/Tricore/System/Systems/SysSW_Supervisor.h" 1
# 11 "./0_Src/0_AppSw/Tricore/System/Systems/SysSW_Supervisor.h"
...
# 12 "./0_Src/0_AppSw/Tricore/System/Systems/SysSW_Supervisor.h" 2
# 1 "./0_Src/0_AppSw/Tricore/System/DataStructure/Process_Queue_sh.h" 1
# 11 "./0_Src/0_AppSw/Tricore/System/DataStructure/Process_Queue_sh.h"
# 1 "./0_Src/0_AppSw/Tricore/System/Service_Handler/Frame_Define.h" 1
# 17 "./0_Src/0_AppSw/Tricore/System/Service_Handler/Frame_Define.h"
typedef struct {
 uint16 ID;
 uint16 DLC;
...
typedef struct {
 ...
 volatile uint8 DesAddr[6];
 volatile uint8 SrcAddr[6];


 volatile uint16 Eth_Type;

 volatile ETH_VLAN_FORMAT *Eth_VLAN;


 volatile uint8 Eth_DSAP;
 volatile uint8 Eth_SSAP;
 volatile uint8 Eth_Ctrl[2];


 volatile uint8 OUI_Number[3];
 volatile uint16 Protocol_ID;



}Ethernet_Frame;
# 12 "./0_Src/0_AppSw/Tricore/System/DataStructure/Process_Queue_sh.h" 2
...
# 13 "./0_Src/0_AppSw/Tricore/System/Systems/SysSW_Supervisor.h" 2

void Init_sch_core1(void);
int runn_sch_core1(void);
void insert_sch_core1(int type, int n_fnc);
# 17 "0_Src/0_AppSw/Tricore/Application/Application.c" 2
# 29 "0_Src/0_AppSw/Tricore/Application/Application.c"
...
uint8 SRC_uMAC[6] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55};
uint8 DES_uMAC[6] = {0xE0, 0xCB, 0x4E, 0xEC, 0xEF, 0x73};
...
# 88 "0_Src/0_AppSw/Tricore/Application/Application.c"
...
# 238 "0_Src/0_AppSw/Tricore/Application/Application.c"
   {
...
# 372 "0_Src/0_AppSw/Tricore/Application/Application.c"
 switch(task_temp.task_num)
 {
  ...
  case 1:
   ...
   if( task_temp.deadline_ == 5005){
    Core_Queue[0].queue_deadmiss++;
    Core_Queue[0].task_info[(Core_Queue[0].front+1)% 32].deadline_++;
    printf_SysLog("***miss***\r\n");
   }
   break;
  case 2:
...
# 598 "0_Src/0_AppSw/Tricore/Application/Application.c"
...
# 617 "0_Src/0_AppSw/Tricore/Application/Application.c"
 if(is_empty(&Core_Queue[0])==0)
 {
  ...
  if(task_end_0[task_temp.task_num] == 1)
  {
   ...
   IO_set_CAN_msgObject(0, 0, 11, 8, 0);
   IO_Send_CAN(0, CAN0_DataTx, 8);
...
# 675 "0_Src/0_AppSw/Tricore/Application/Application.c"
}
...
void Runn20(void)
{
 ...
 memset(&new_task, 0, sizeof(task_info));
 memset(&task_temp, 0, sizeof(task_info));
# 714 "0_Src/0_AppSw/Tricore/Application/Application.c"
...

 {
  ...
  if((is_empty(&priority[idx]) == 0))
  {
   ...
   new_task = dequeue(&priority[idx]);
# 739 "0_Src/0_AppSw/Tricore/Application/Application.c"
   {
...
# 883 "0_Src/0_AppSw/Tricore/Application/Application.c"
 switch(task_temp.task_num)
 {
  case 1:
# 894 "0_Src/0_AppSw/Tricore/Application/Application.c"
   task_count_1[0]++;
   delay_ms(time_offset);
  ...
  case 2:
   ...
   break;
  case 3:
# 954 "0_Src/0_AppSw/Tricore/Application/Application.c"
   task_count_1[2]++;
   delay_ms(time_offset);
 ...
 if(is_empty(&Core_Queue[1])==0)
 {
  ...
  if(task_end_1[task_temp.task_num] == 1)
  {
   ...
   IO_set_CAN_msgObject(1, 1, 13, 8, 0);
   IO_Send_CAN(1, CAN1_DataTx, 8);



  }
 }
# 1202 "0_Src/0_AppSw/Tricore/Application/Application.c"
}
...
void Set_CAN_DB(void)
{
 ...
 msgValue1 = set_CAN_DB_msgObject(0, 0, 0x405, 8, 4, 100.0, 100.0);
 ...
 msgValue2 = set_CAN_DB_msgObject(1, 0, 0x406, 8, 4, 100.0, 100.0);
 ...
 msgValue3 = set_CAN_DB_msgObject(2, 0, 0x407, 4, 4, 100.0, 100.0);
