...
# 1107 "./0_Src/4_McHal/Tricore/_Reg/IfxCcu6_regdef.h"
...
# 297 "./0_Src/4_McHal/Tricore/_PinMap/IfxCcu6_PinMap.h"
...
typedef enum
{
    IfxCcu6_CaptureCompareInput_cC60 = (0),
...
typedef enum
{
    IfxCcu6_InterruptSource_cc60RisingEdge = (0),

    IfxCcu6_InterruptSource_cc60FallingEdge = (1),

    IfxCcu6_InterruptSource_cc61RisingEdge = (2),

    IfxCcu6_InterruptSource_cc61FallingEdge = (3),

    IfxCcu6_InterruptSource_cc62RisingEdge = (4),

    IfxCcu6_InterruptSource_cc62FallingEdge = (5),

    IfxCcu6_InterruptSource_t12OneMatch = (6),
    IfxCcu6_InterruptSource_t12PeriodMatch = (7),
    IfxCcu6_InterruptSource_t13CompareMatch = (8),
    IfxCcu6_InterruptSource_t13PeriodMatch = (9),
    IfxCcu6_InterruptSource_trap = (10),
    IfxCcu6_InterruptSource_correctHallEvent = (12),
    IfxCcu6_InterruptSource_wrongHallEvent = (13)
...
static inline __attribute__ ((always_inline)) void IfxCcu6_clearCounter(Ifx_CCU6 *ccu6, unsigned char t12, unsigned char t13);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_isModuleEnabled(Ifx_CCU6 *ccu6);





static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_isT12OneNotification(Ifx_CCU6 *ccu6);





static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_isT12PeriodNotification(Ifx_CCU6 *ccu6);





static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_isT13CompareNotification(Ifx_CCU6 *ccu6);
...
static inline __attribute__ ((always_inline)) void IfxCcu6_setOutputPassiveState(Ifx_CCU6 *ccu6, IfxCcu6_ChannelOut channelOut, unsigned char state);
...
static inline __attribute__ ((always_inline)) void IfxCcu6_setSingleShotModeEnable(Ifx_CCU6 *ccu6, unsigned char t12, unsigned char t13);
...
static inline __attribute__ ((always_inline)) void IfxCcu6_startTimer(Ifx_CCU6 *ccu6, unsigned char t12, unsigned char t13);
...
static inline __attribute__ ((always_inline)) void IfxCcu6_stopTimer(Ifx_CCU6 *ccu6, unsigned char t12, unsigned char t13);
...
extern void IfxCcu6_setOutputPassiveLevel(Ifx_CCU6 *ccu6, IfxCcu6_ChannelOut channelOut, unsigned char state);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_getDeadTimeStatus(Ifx_CCU6 *ccu6, IfxCcu6_T12Channel channel);
# 762 "./0_Src/4_McHal/Tricore/Ccu6/Std/IfxCcu6.h"
static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_getHallPatternSampleState(Ifx_CCU6 *ccu6, IfxCcu6_T12Channel channel);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_getInterruptStatusFlag(Ifx_CCU6 *ccu6, IfxCcu6_InterruptSource source);





static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_getMultiChannelModeAvailabilityStatus(Ifx_CCU6 *ccu6);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_getMultiChannelPWMPatternShadowTransferStatus(Ifx_CCU6 *ccu6);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_getShadowTransferStatus(Ifx_CCU6 *ccu6, IfxCcu6_TimerId timer);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_getT12CaptureCompareState(Ifx_CCU6 *ccu6, IfxCcu6_T12Channel channel);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_getT13CaptureCompareState(Ifx_CCU6 *ccu6);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCcu6_getTimerAvailabilityStatus(Ifx_CCU6 *ccu6, IfxCcu6_TimerId timer);
...
static inline __attribute__ ((always_inline)) void IfxCcu6_disableShadowTransfer(Ifx_CCU6 *ccu6, unsigned char t12, unsigned char t13);
...
static inline __attribute__ ((always_inline)) void IfxCcu6_enableCountEvent(Ifx_CCU6 *ccu6, unsigned char t12, unsigned char t13);
...
static inline __attribute__ ((always_inline)) void IfxCcu6_enableShadowTransfer(Ifx_CCU6 *ccu6, unsigned char t12, unsigned char t13);
...
extern unsigned char IfxCcu6_TimerWithTrigger_acknowledgeTimerIrq(IfxCcu6_TimerWithTrigger *driver);
# 110 "./0_Src/4_McHal/Tricore/Ccu6/TimerWithTrigger/IfxCcu6_TimerWithTrigger.h"
extern unsigned char IfxCcu6_TimerWithTrigger_acknowledgeTriggerIrq(IfxCcu6_TimerWithTrigger *driver);
...
extern unsigned char IfxCcu6_TimerWithTrigger_setFrequency(IfxCcu6_TimerWithTrigger *driver, float32 frequency);
# 194 "./0_Src/4_McHal/Tricore/Ccu6/TimerWithTrigger/IfxCcu6_TimerWithTrigger.h"
extern unsigned char IfxCcu6_TimerWithTrigger_setPeriod(IfxCcu6_TimerWithTrigger *driver, Ifx_TimerValue period);
# 204 "./0_Src/4_McHal/Tricore/Ccu6/TimerWithTrigger/IfxCcu6_TimerWithTrigger.h"
extern void IfxCcu6_TimerWithTrigger_setSingleMode(IfxCcu6_TimerWithTrigger *driver, unsigned char enabled);
...
extern unsigned char IfxCcu6_TimerWithTrigger_stdIfTimerInit(IfxStdIf_Timer *stdif, IfxCcu6_TimerWithTrigger *driver);
...
extern unsigned char IfxCcu6_TimerWithTrigger_init(IfxCcu6_TimerWithTrigger *driver, IfxCcu6_TimerWithTrigger_Config *config);
...
extern unsigned char IfxCcu6_PwmHl_init(IfxCcu6_PwmHl *driver, const IfxCcu6_PwmHl_Config *config);
...
extern unsigned char IfxCcu6_PwmHl_setDeadtime(IfxCcu6_PwmHl *driver, float32 deadtime);
# 213 "0_Src/4_McHal/Tricore/Ccu6/PwmHl/IfxCcu6_PwmHl.h"
extern unsigned char IfxCcu6_PwmHl_setMinPulse(IfxCcu6_PwmHl *driver, float32 minPulse);
# 223 "0_Src/4_McHal/Tricore/Ccu6/PwmHl/IfxCcu6_PwmHl.h"
extern unsigned char IfxCcu6_PwmHl_setMode(IfxCcu6_PwmHl *driver, Ifx_Pwm_Mode mode);
...
extern void IfxCcu6_PwmHl_setupChannels(IfxCcu6_PwmHl *driver, unsigned char *activeCh, unsigned char *stuckSt);
...
extern unsigned char IfxCcu6_PwmHl_stdIfPwmHlInit(IfxStdIf_PwmHl *stdif, IfxCcu6_PwmHl *driver);
...
# 147 "0_Src/4_McHal/Tricore/Ccu6/PwmHl/IfxCcu6_PwmHl.c"
...

    {
        ...
        unsigned char active[6] = {0, 0, 0, 0, 0, 0};
        unsigned char stuckState[6] = {0, 0, 0, 0, 0, 0};
...
static void IfxCcu6_PwmHl_enable(IfxCcu6_PwmHl *driver)
{
    ...
    module->CMPSTAT.U = cmpstat.U;
    {
        ...
        unsigned char active[6] = {1, 1, 1, 1, 1, 1};
        unsigned char stuckState[6] = {0, 0, 0, 0, 0, 0};
        IfxCcu6_PwmHl_setupChannels(driver, active, stuckState);
    }
}
...
unsigned char IfxCcu6_PwmHl_init(IfxCcu6_PwmHl *driver, const IfxCcu6_PwmHl_Config *config)
{
...
unsigned char IfxCcu6_PwmHl_setDeadtime(IfxCcu6_PwmHl *driver, float32 deadtime)
{
...
unsigned char IfxCcu6_PwmHl_setMinPulse(IfxCcu6_PwmHl *driver, float32 minPulse)
{
...
unsigned char IfxCcu6_PwmHl_setMode(IfxCcu6_PwmHl *driver, Ifx_Pwm_Mode mode)
{
    unsigned char result = 1;
...
void IfxCcu6_PwmHl_setupChannels(IfxCcu6_PwmHl *driver, unsigned char *activeCh, unsigned char *stuckSt)
{
    IfxCcu6_TimerWithTrigger *timer = driver->timer;
    Ifx_CCU6 *module = timer->ccu6;
    {
...
unsigned char IfxCcu6_PwmHl_stdIfPwmHlInit(IfxStdIf_PwmHl *stdif, IfxCcu6_PwmHl *driver)
{
