...
typedef struct
{
    ...
    unsigned char t13InSyncWithT12;
...
typedef struct
{
    ...
    Ifx_CCU6 *ccu6;
    IfxCcu6_TimerId timer;
    unsigned char synchronousOperation;
...
typedef struct
{
    ...
    unsigned char multiInputCaptureEnabled;
    IfxCcu6_Timer timer;
