...
# 728 "./0_Src/4_McHal/Tricore/_Reg/IfxSent_regdef.h"
...
# 758 "./0_Src/4_McHal/Tricore/_Reg/IfxSent_regdef.h"
...
# 115 "./0_Src/4_McHal/Tricore/_PinMap/IfxSent_PinMap.h"
...
typedef struct
{
    unsigned char inputPulsePolarityHigh;
    unsigned char outputPulsePolarityHigh;
    unsigned char edgeCounterCleared;
    unsigned char glitchFallingCleared;
    unsigned char glitchRisingCleared;
    unsigned char triggerMonitorCleared;
...
typedef struct
{
    unsigned char crcModeDisabled;
    unsigned char crcMethodDisabled;
    unsigned char alternateCrcSelected;
    unsigned char serialDataProcessingEnabled;
    unsigned char serialDataDisabledCrcDisabled;
    unsigned char statusNibbleEnabled;
    unsigned char driftErrorsDisabled;
    unsigned char endPulseIgnored;
    unsigned char suspendTriggered;
    uint8 frameLength;
...
{
    Ifx_SENT *module;
    unsigned char sleepModeEnabled;
...
extern unsigned char IfxSent_Sent_initModule(IfxSent_Sent *driver, const IfxSent_Sent_Config *config);
...
extern unsigned char IfxSent_Sent_initChannel(IfxSent_Sent_Channel *channel, const IfxSent_Sent_ChannelConfig *config);
...
extern unsigned char IfxSent_Sent_readChannelSerialDataFrame(IfxSent_Sent_Channel *channel, IfxSent_Sent_Frame *frame);
# 661 "0_Src/4_McHal/Tricore/Sent/Sent/IfxSent_Sent.h"
extern unsigned char IfxSent_Sent_readChannelSerialMessageFrame(IfxSent_Sent_Channel *channel, IfxSent_Sent_SerialMessageFrame *message);
...
unsigned char IfxSent_Sent_initChannel(IfxSent_Sent_Channel *channel, const IfxSent_Sent_ChannelConfig *config)
{
...
unsigned char IfxSent_Sent_initModule(IfxSent_Sent *driver, const IfxSent_Sent_Config *config)
{
    unsigned char result = 1;
...
unsigned char IfxSent_Sent_readChannelSerialDataFrame(IfxSent_Sent_Channel *channel, IfxSent_Sent_Frame *frame)
{
    unsigned char result = 1;
...
unsigned char IfxSent_Sent_readChannelSerialMessageFrame(IfxSent_Sent_Channel *channel, IfxSent_Sent_SerialMessageFrame *message)
{
    unsigned char result = 1;
