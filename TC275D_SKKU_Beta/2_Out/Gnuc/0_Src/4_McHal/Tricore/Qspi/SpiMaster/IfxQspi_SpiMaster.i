...
# 44 "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
static IfxQspi_SpiMaster_Channel *IfxQspi_SpiMaster_activeChannel(IfxQspi_SpiMaster *handle);
# 59 "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
...
static void IfxQspi_SpiMaster_autoSlso(IfxQspi_SpiMaster_Channel *chHandle);
...
# 108 "0_Src/4_McHal/Tricore/Qspi/SpiMaster/IfxQspi_SpiMaster.c"
...
SpiIf_Status IfxQspi_SpiMaster_initChannel(IfxQspi_SpiMaster_Channel *chHandle, const IfxQspi_SpiMaster_ChannelConfig *chConfig)
{
    ...
    else
    {
        ...
        {
            chHandle->activateSlso = &IfxQspi_SpiMaster_autoSlso;
            chHandle->deactivateSlso = &IfxQspi_SpiMaster_autoSlso;
    ...
    else
    {
        if (job->remaining > 0)
        {
            ...
            if (count > 0)
            {
                ...
                unsigned char lastWrite = job->remaining == 0;
