...
uint32 IfxQspi_recalcBasicConfiguration(uint32 oldBACON, Ifx_SizeT numOfData, unsigned char shortData, unsigned char lastData)
{
    Ifx_QSPI_BACON bacon;
    bacon.U = oldBACON;
...
void IfxQspi_setSlaveSelectOutputControl(Ifx_QSPI *qspi, IfxQspi_ChannelId channelId, unsigned char outputEnable, unsigned char activeLevel)
{
