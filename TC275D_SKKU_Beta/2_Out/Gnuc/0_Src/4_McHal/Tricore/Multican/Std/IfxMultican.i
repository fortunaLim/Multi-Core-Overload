...
unsigned char IfxMultican_MsgObj_cancelSend(Ifx_CAN_MO *hwObj)
{
...
unsigned char IfxMultican_MsgObj_getStatusFlag(Ifx_CAN_MO *hwObj, IfxMultican_MsgObjStatusFlag flag)
{
...
IfxMultican_Status IfxMultican_MsgObj_readLongFrame(Ifx_CAN *mcan, IfxMultican_MsgObjId msgObjId, IfxMultican_Message *msg, uint32 *data)
{
    ...
    unsigned char longFrame = (hwObj->FCR.B.FDF != 0) ? 1 : 0;
    ...
    if (longFrame)
    {
        ...
        else
        {
...

            {
                ...
                unsigned char extendedFrame = IfxMultican_MsgObj_isExtendedFrame(hwObj);
...
void IfxMultican_MsgObj_setFilter(Ifx_CAN_MO *hwObj, unsigned char extend, uint32 id, uint32 accMask)
{
    Ifx_CAN_MO_CTR ctr;
...
unsigned char IfxMultican_Node_initRxPin(Ifx_CAN_N *hwNode, IfxMultican_Rxd_In *rxd, IfxPort_InputMode mode)
{
...
unsigned char IfxMultican_Node_initTxPin(Ifx_CAN_N *hwNode, IfxMultican_Txd_Out *txd, IfxPort_OutputMode mode)
{
...
IfxMultican_Status IfxMultican_Node_recoverBusOff(Ifx_CAN_N *hwNode)
{
    ...
    unsigned char busOffState = hwNode->SR.B.BOFF;
    unsigned char errorWarningStatus = hwNode->SR.B.EWRN;
