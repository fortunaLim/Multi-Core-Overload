...
uint16 IfxEray_calcHeaderCrc(uint8 payloadLength, uint16 frameId, unsigned char startupFrameIndicator, unsigned char syncFrameIndicator)
{
...
unsigned char IfxEray_changePocState(Ifx_ERAY *eray, IfxEray_PocCommand pocCommand)
{
