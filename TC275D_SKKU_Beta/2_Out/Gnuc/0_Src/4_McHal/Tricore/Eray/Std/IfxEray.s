...
.LFE260:
	...
	.align 1
	.global	IfxEray_readData_Byte
	.type	IfxEray_readData_Byte, @function
IfxEray_readData_Byte:
.LFB261:
	.loc 1 147 0
.LVL32:
	.loc 1 148 0
...
.LBE18:
.LFE261:
	.size	IfxEray_readData_Byte, .-IfxEray_readData_Byte
	.align 1
...
.LBB20:
	...
	.loc 1 174 0
	ins.t	%d3, %d3,8, %d15,28
	.loc 1 175 0
	ins.t	%d5, %d5,14, %d15,27
	.loc 1 176 0
	ins.t	%d5, %d5,15, %d15,26
	.loc 1 177 0
	ins.t	%d3, %d3,0, %d15,25
	.loc 1 178 0
	extr.u	%d15, %d15, 16, 6
	.loc 1 176 0
	st.h	[%a5] 2, %d5
	.loc 1 178 0
	insert	%d3, %d3, %d15, 1, 7
	st.h	[%a5] 4, %d3
.LBE20:
.LBB21:
.LBB22:
