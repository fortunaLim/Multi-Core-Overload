...
# 42 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
...
# 43 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h" 2
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxMc_bf.h" 1
# 44 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h" 2
# 60 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
static inline __attribute__ ((always_inline)) void IfxMtu_enableModule(void);




static inline __attribute__ ((always_inline)) unsigned char IfxMtu_isModuleEnabled(void);
# 86 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
extern void IfxMtu_disableMbistShell(IfxMtu_MbistSel mbistSel);
# 112 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
...
extern unsigned char IfxMtu_isAutoInitRunning(IfxMtu_MbistSel mbistSel);
# 167 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
...
# 208 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
...
# 242 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
...
# 284 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
...
# 307 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
...
extern void IfxMtu_enableErrorTracking(IfxMtu_MbistSel mbistSel, unsigned char enable);
# 327 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
extern uint32 IfxMtu_getSystemAddress(IfxMtu_MbistSel mbistSel, Ifx_MC_ETRR trackedSramAddress);
# 377 "./0_Src/4_McHal/Tricore/Mtu/Std/IfxMtu.h"
...
extern unsigned char IfxMtu_isErrorTrackingEnabled(IfxMtu_MbistSel mbistSel);
...
extern unsigned char IfxMtu_isErrorTrackingOverflow(IfxMtu_MbistSel mbistSel);
...
static void IfxEray_Eray_Node_initCommunicationController(IfxEray_Eray *eray, IfxEray_Eray_ControllerConfig *config);
...
static void IfxEray_Eray_Node_initGTU(IfxEray_Eray *eray, IfxEray_Eray_GTUConfig *config);
...
static void IfxEray_Eray_Node_initMessageRAM(IfxEray_Eray *eray, IfxEray_Eray_MessageRAMConfig *config);
...
void IfxEray_Eray_Node_init(IfxEray_Eray *eray, IfxEray_Eray_NodeConfig *config)
{
    Ifx_ERAY *eraySFR = eray->eray;
...
void IfxEray_Eray_Node_initConfig(IfxEray_Eray_NodeConfig *config)
{
    ...
    const IfxEray_Eray_NodeConfig nodeConfig = {
        ...
        .controllerConfig = {
            ...
            .gtuConfig = {
                .gtu01Config.microticksPerCycle = 0x9C400,

                .gtu02Config = {
                    .macroticksPerCycle = 0x3E80,
                    .maxSyncFrames = 0x4
                },
