# 1 "0_Src/4_McHal/Tricore/I2c/I2c/IfxI2c_I2c.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/I2c/I2c/IfxI2c_I2c.c"
# 29 "0_Src/4_McHal/Tricore/I2c/I2c/IfxI2c_I2c.c"
...
# 39 "./0_Src/4_McHal/Tricore/_Impl/IfxI2c_cfg.h"
...
# 40 "./0_Src/4_McHal/Tricore/_Impl/IfxI2c_cfg.h" 2
...
# 41 "./0_Src/4_McHal/Tricore/I2c/Std/IfxI2c.h" 2
...
# 30 "0_Src/4_McHal/Tricore/I2c/I2c/IfxI2c_I2c.c" 2
...
IfxI2c_I2c_Status IfxI2c_I2c_read(IfxI2c_I2c_Device *i2cDevice, volatile uint8 *data, Ifx_SizeT size)
{
    ...
    while ((i2c->PIRQSM.U & ((1 << (3)) | (1 << (4)) | (1 << (6)) || i2c->ERRIRQSS.U)))
    {}
...

    {
        if (size > 32)
        {
            unsigned char intEnabled = IfxCpu_disableInterrupts();
            uint32 i;
