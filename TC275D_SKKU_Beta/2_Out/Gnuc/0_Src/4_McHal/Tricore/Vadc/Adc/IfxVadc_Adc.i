...
# 95 "./0_Src/4_McHal/Tricore/_Impl/IfxVadc_cfg.h"
typedef enum
{
    IfxVadc_GroupId_0 = 0,
    IfxVadc_GroupId_1 = 1,
...
{
    unsigned int CALORD : 1;
    unsigned int reserved_1 : 1;
    unsigned int ARCDIS : 1;
    unsigned int ARCH : 1;
    unsigned int AREFDEF : 3;
    unsigned int ARM : 1;
    unsigned int CALGNSTC : 6;
    unsigned int reserved_14 : 2;
    unsigned int SUCALVAL : 7;
    unsigned int reserved_23 : 1;
    unsigned int CALMAX : 6;
...
{
    unsigned int CALGNVALS : 14;
    unsigned int reserved_14 : 1;
    unsigned int GNSWC : 1;
    unsigned int CALGNVALA : 14;
    unsigned int reserved_30 : 1;
    unsigned int GNAWC : 1;
} Ifx_VADC_SHS_CALGC_Bits;


typedef struct _Ifx_VADC_SHS_CALOC_Bits
{
    unsigned int CALOFFVAL0 : 7;
    unsigned int reserved_7 : 8;
    unsigned int OFFWC : 1;
    unsigned int reserved_16 : 15;
    unsigned int DISCAL : 1;
...
typedef struct _Ifx_VADC_SHS_SHSCFG_Bits
{
    unsigned int DIVS : 4;
    unsigned int reserved_4 : 1;
    unsigned int SYNSH23 : 2;
    unsigned int SYNSH01 : 2;
    unsigned int reserved_9 : 1;
    unsigned int AREF : 2;
    unsigned int ANOFF : 1;
    unsigned int reserved_13 : 1;
    unsigned int ANRDY : 1;
    unsigned int SCWC : 1;
    unsigned int SP0 : 1;
    unsigned int SP1 : 1;
    unsigned int SP2 : 1;
...
{
    unsigned int KSEL0 : 3;
    unsigned int SEN0 : 1;
    unsigned int KSEL1 : 3;
    unsigned int SEN1 : 1;
    unsigned int KSEL2 : 3;
    unsigned int SEN2 : 1;
    unsigned int KSEL3 : 3;
    unsigned int SEN3 : 1;
    unsigned int KSEL4 : 3;
    unsigned int SEN4 : 1;
    unsigned int KSEL5 : 3;
    unsigned int SEN5 : 1;
    unsigned int KSEL6 : 3;
    unsigned int SEN6 : 1;
    unsigned int KSEL7 : 3;
    unsigned int SEN7 : 1;
...
# 1773 "./0_Src/4_McHal/Tricore/_Reg/IfxVadc_regdef.h"
...
typedef volatile struct _Ifx_VADC_SHS
{
    ...
    Ifx_VADC_SHS_SHSCFG SHSCFG;
    Ifx_VADC_SHS_STEPCFG STEPCFG;
    unsigned char reserved_48[56];
    Ifx_VADC_SHS_TIMCFG TIMCFG[4];
    unsigned char reserved_90[44];
    Ifx_VADC_SHS_CALCTR CALCTR;
    Ifx_VADC_SHS_CALGC CALGC[4];
    unsigned char reserved_D0[16];
    Ifx_VADC_SHS_CALOC CALOC[4];
    unsigned char reserved_F0[272];
} Ifx_VADC_SHS;
# 1869 "./0_Src/4_McHal/Tricore/_Reg/IfxVadc_regdef.h"
typedef volatile struct _Ifx_VADC
{
    ...
    Ifx_VADC_G G[8];
    unsigned char reserved_2480[11136];
    Ifx_VADC_SHS SHS[2];
    unsigned char reserved_5400[3072];
} Ifx_VADC;
...
typedef struct
{
    ...
    unsigned char disableWatchdog;
    unsigned char enableSmuRestriction;
    unsigned char enableAutomaticPasswordChange;
    unsigned char enableTimerCheck;
    unsigned char enableTimerCheckTolerance;
    unsigned char clrInternalResetFlag;
} IfxScuWdt_Config;
...
static inline __attribute__ ((always_inline)) unsigned char IfxScuWdt_getSafetyWatchdogEndInit(void);
...
static inline __attribute__ ((always_inline)) unsigned char IfxScuWdt_getSafetyWatchdogEndInit(void)
{
    return (unsigned char)((*(Ifx_SCU *)0xF0036000u)).WDTS.CON0.B.ENDINIT;
}
...
static inline __attribute__ ((always_inline)) unsigned char IfxPort_getPinState(Ifx_P *port, uint8 pinIndex);
...
extern unsigned char IfxPort_disableEmergencyStop(Ifx_P *port, uint8 pinIndex);
# 339 "./0_Src/4_McHal/Tricore/Port/Std/IfxPort.h"
extern unsigned char IfxPort_enableEmergencyStop(Ifx_P *port, uint8 pinIndex);
...
# 174 "./0_Src/4_McHal/Tricore/_PinMap/IfxVadc_PinMap.h"
...
static inline __attribute__ ((always_inline)) void IfxCpu_setSafetyTaskIdentifier(unsigned char safetyId);
...
extern unsigned char IfxCpu_setCoreMode(Ifx_CPU *cpu, IfxCpu_CoreMode mode);
# 228 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.h"
extern unsigned char IfxCpu_setProgramCounter(Ifx_CPU *cpu, uint32 programCounter);
# 237 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.h"
extern unsigned char IfxCpu_startCore(Ifx_CPU *cpu, uint32 programCounter);
# 254 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.h"
static inline __attribute__ ((always_inline)) unsigned char IfxCpu_areInterruptsEnabled(void);
# 264 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.h"
static inline __attribute__ ((always_inline)) unsigned char IfxCpu_disableInterrupts(void);
...
static inline __attribute__ ((always_inline)) void IfxCpu_restoreInterrupts(unsigned char enabled);
# 302 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.h"
static inline __attribute__ ((always_inline)) void IfxCpu_enableSegmentSpecificDataAccessCacheability(uint16 segmentNumberMask, unsigned char enable);
# 311 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.h"
static inline __attribute__ ((always_inline)) void IfxCpu_enableSegmentSpecificInstructionAccessCacheability(uint16 segmentNumberMask, unsigned char enable);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCpu_isAddressCachable(void *address);
# 333 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.h"
static inline __attribute__ ((always_inline)) void IfxCpu_setDataCache(unsigned char enable);
# 344 "./0_Src/4_McHal/Tricore/Cpu/Std/IfxCpu.h"
static inline __attribute__ ((always_inline)) void IfxCpu_setProgramCache(unsigned char enable);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCpu_getClockCounterStickyOverflow(void);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCpu_getInstructionCounterStickyOverflow(void);
...
static inline __attribute__ ((always_inline)) unsigned char IfxCpu_getPerformanceCounterStickyOverflow(uint32 address);
...
extern unsigned char IfxCpu_acquireMutex(IfxCpu_mutexLock *lock);
...
extern unsigned char IfxCpu_setSpinLock(IfxCpu_spinLock *lock, uint32 timeoutCount);
...
# 68 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
typedef enum
{
...
# 475 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
static inline __attribute__ ((always_inline)) void IfxVadc_configureWaitForReadMode(Ifx_VADC_G *group, uint32 resultIdx, unsigned char waitForRead);
...
static inline __attribute__ ((always_inline)) void IfxVadc_configureWaitForReadModeForGlobalResultRegister(Ifx_VADC *vadc, unsigned char waitForRead);
...
# 561 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
# 605 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
static inline __attribute__ ((always_inline)) void IfxVadc_getGroupResult(Ifx_VADC_G *group, Ifx_VADC_RES *results, uint32 resultOffset, uint32 numResults);
# 639 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
static inline __attribute__ ((always_inline)) Ifx_VADC_RES IfxVadc_getResult(Ifx_VADC_G *group, uint32 resultIdx);





static inline __attribute__ ((always_inline)) unsigned char IfxVadc_isAutoBackgroundScanEnabled(Ifx_VADC *vadc);





static inline __attribute__ ((always_inline)) unsigned char IfxVadc_isRequestBackgroundScanSlotEnabled(Ifx_VADC_G *vadcG);
...
static inline __attribute__ ((always_inline)) void IfxVadc_setAutoBackgroundScan(Ifx_VADC *vadc, unsigned char autoBackgroundScanEnable);
# 689 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
# 714 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
static inline __attribute__ ((always_inline)) void IfxVadc_startBackgroundScan(Ifx_VADC *vadc);
# 724 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
extern IfxVadc_Status IfxVadc_getBackgroundScanStatus(Ifx_VADC *vadc);
# 761 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
extern Ifx_VADC_RES IfxVadc_getResultBasedOnRequestSource(Ifx_VADC *vadc, Ifx_VADC_G *group, IfxVadc_ChannelId channel, IfxVadc_RequestSource sourceType);
# 776 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
static inline __attribute__ ((always_inline)) unsigned char IfxVadc_isAutoScanEnabled(Ifx_VADC_G *vadcG);





static inline __attribute__ ((always_inline)) unsigned char IfxVadc_isRequestScanSlotEnabled(Ifx_VADC_G *vadcG);
...
static inline __attribute__ ((always_inline)) void IfxVadc_setAutoScan(Ifx_VADC_G *vadcG, unsigned char autoscanEnable);
...
static inline __attribute__ ((always_inline)) void IfxVadc_clearQueue(Ifx_VADC_G *vadcG, unsigned char flushQueue);
...
static inline __attribute__ ((always_inline)) unsigned char IfxVadc_isRequestQueueSlotEnabled(Ifx_VADC_G *vadcG);
...
# 1026 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
extern IfxVadc_Status IfxVadc_getQueueStatus(Ifx_VADC_G *group);
# 1043 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
# 1077 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
# 1098 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
# 1165 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
# 1186 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
extern void IfxVadc_setArbiterPriority(Ifx_VADC_G *vadcG, unsigned char slotEnable, IfxVadc_RequestSlotPriority prio, IfxVadc_RequestSlotStartMode mode, IfxVadc_RequestSource slot);
# 1201 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
static inline __attribute__ ((always_inline)) IfxScuCcu_AdcClockSelection IfxVadc_getConverterClockType(void);
...
static inline __attribute__ ((always_inline)) unsigned char IfxVadc_getStartupCalibration(Ifx_VADC *vadc);
...
# 1254 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
# 1272 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
extern void IfxVadc_disablePostCalibration(Ifx_VADC *vadc, IfxVadc_GroupId group, unsigned char disable);
...
extern unsigned char IfxVadc_isPostCalibration(Ifx_VADC *vadc, IfxVadc_GroupId group);
...
# 1362 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
static inline __attribute__ ((always_inline)) void IfxVadc_enableFifoMode(Ifx_VADC_G *vadcG, IfxVadc_ChannelResult resultRegister);
...
static inline __attribute__ ((always_inline)) Ifx_VADC_CHCTR IfxVadc_getChannelControlConfig(Ifx_VADC_G *vadcG, IfxVadc_ChannelId channelIndex);
...
static inline __attribute__ ((always_inline)) void IfxVadc_setBackgroundResultTarget(Ifx_VADC_G *vadcG, IfxVadc_ChannelId channelIndex, unsigned char globalResultUsage);
...
static inline __attribute__ ((always_inline)) void IfxVadc_setResultPosition(Ifx_VADC_G *vadcG, IfxVadc_ChannelId channelIndex, unsigned char rightAlignedStorage);
...
static inline __attribute__ ((always_inline)) void IfxVadc_setSyncRequest(Ifx_VADC_G *vadcG, IfxVadc_ChannelId channelIndex, unsigned char synchonize);
...
# 1537 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
# 1554 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
# 1585 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
# 1635 "./0_Src/4_McHal/Tricore/Vadc/Std/IfxVadc.h"
...
static inline __attribute__ ((always_inline)) IfxScuCcu_AdcClockSelection IfxVadc_getConverterClockType(void)
{
    return (IfxScuCcu_AdcClockSelection)((*(Ifx_SCU *)0xF0036000u)).CCUCON0.B.ADCCLKSEL;
}
...
static inline __attribute__ ((always_inline)) unsigned char IfxVadc_getStartupCalibration(Ifx_VADC *vadc)
{
    return (unsigned char)vadc->GLOBCFG.B.SUCAL;
}
...
static inline __attribute__ ((always_inline)) unsigned char IfxVadc_isAutoBackgroundScanEnabled(Ifx_VADC *vadc)
{
    return (unsigned char)vadc->BRSMR.B.SCAN;
}


static inline __attribute__ ((always_inline)) unsigned char IfxVadc_isAutoScanEnabled(Ifx_VADC_G *vadcG)
{
    return (unsigned char)vadcG->ASMR.B.SCAN;
}


static inline __attribute__ ((always_inline)) unsigned char IfxVadc_isRequestBackgroundScanSlotEnabled(Ifx_VADC_G *vadcG)
{
    return (unsigned char)vadcG->ARBPR.B.ASEN2;
}


static inline __attribute__ ((always_inline)) unsigned char IfxVadc_isRequestQueueSlotEnabled(Ifx_VADC_G *vadcG)
{
    return (unsigned char)vadcG->ARBPR.B.ASEN0;
}


static inline __attribute__ ((always_inline)) unsigned char IfxVadc_isRequestScanSlotEnabled(Ifx_VADC_G *vadcG)
{
    return (unsigned char)vadcG->ARBPR.B.ASEN1;
}
...
static inline __attribute__ ((always_inline)) void IfxVadc_setMasterIndex(Ifx_VADC_G *vadcG, uint8 masterIndex)
{
    vadcG->SYNCTR.B.STSEL = masterIndex;
    vadcG->SYNCTR.U |= (0x00000008U << masterIndex);
}
...
static inline __attribute__ ((always_inline)) void IfxVadc_setResultNodeEventPointer0(Ifx_VADC_G *vadcG, IfxVadc_SrcNr resultSrcNr, IfxVadc_ChannelResult resultRegister)
{
    vadcG->REVNP0.U &= ~((0xf) << (resultRegister * 4));
...
static inline __attribute__ ((always_inline)) void IfxVadc_setResultNodeEventPointer1(Ifx_VADC_G *vadcG, IfxVadc_SrcNr resultSrcNr, IfxVadc_ChannelResult resultRegister)
{
    vadcG->REVNP1.U &= ~((0xf) << ((resultRegister - IfxVadc_ChannelResult_8) * 4));
...
# 360 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
typedef struct
{
    Ifx_VADC *vadc;
} IfxVadc_Adc;
...
typedef struct
{
    ...
    unsigned char requestSlotQueueEnabled;
    unsigned char requestSlotScanEnabled;
    unsigned char requestSlotBackgroundScanEnabled;
...
typedef struct
{
    unsigned char autoBackgroundScanEnabled;
...
typedef struct
{
    unsigned char flushQueueAfterInit;
    IfxVadc_Adc_GatingTriggerConfig triggerConfig;
    IfxVadc_RequestSlotPriority requestSlotPrio;
    IfxVadc_RequestSlotStartMode requestSlotStartMode;
...
typedef struct
{
    unsigned char globalResultUsage;
    unsigned char synchonize;
    unsigned char backgroundChannel;
    unsigned char rightAlignedStorage;
...
typedef struct
{
    ...
    IfxScuCcu_AdcClockSelection converterClock;
    float32 moduleFrequency;
    unsigned char startupCalibration;
...
typedef struct
{
    ...
    unsigned char disablePostCalibration;
    IfxVadc_Adc_ArbiterConfig arbiter;
} IfxVadc_Adc_GroupConfig;
# 544 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
static inline __attribute__ ((always_inline)) void IfxVadc_Adc_deInitModule(IfxVadc_Adc *vadc);
# 554 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
static inline __attribute__ ((always_inline)) void IfxVadc_Adc_getModuleConfig(IfxVadc_Adc *vadc, IfxVadc_Adc_Config *config);
# 622 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
static inline __attribute__ ((always_inline)) Ifx_VADC_RES IfxVadc_Adc_getResultBasedOnRequestSource(IfxVadc_Adc_Group *group, IfxVadc_ChannelId channel, IfxVadc_RequestSource sourceType);
# 632 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
extern void IfxVadc_Adc_disableModule(Ifx_VADC *vadc);
# 642 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
extern IfxVadc_Status IfxVadc_Adc_initModule(IfxVadc_Adc *vadc, const IfxVadc_Adc_Config *config);
# 652 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
...
extern void IfxVadc_Adc_softCalibration(IfxVadc_GroupId groupId);
# 699 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
static inline __attribute__ ((always_inline)) Ifx_VADC_G *IfxVadc_Adc_getGroupRegsFromGroup(const IfxVadc_Adc_Group *group);
# 786 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
static inline __attribute__ ((always_inline)) void IfxVadc_Adc_getGroupResult(IfxVadc_Adc_Group *group, Ifx_VADC_RES *results, uint32 resultOffset, uint32 numResults);
...
# 805 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
extern void IfxVadc_Adc_deInitGroup(IfxVadc_Adc_Group *group);
# 815 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
extern void IfxVadc_Adc_getGroupConfig(IfxVadc_Adc_Group *group, IfxVadc_Adc_GroupConfig *config);
# 825 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
extern IfxVadc_Status IfxVadc_Adc_initGroup(IfxVadc_Adc_Group *group, const IfxVadc_Adc_GroupConfig *config);
# 835 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
extern void IfxVadc_Adc_initGroupConfig(IfxVadc_Adc_GroupConfig *config, IfxVadc_Adc *vadc);
# 854 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
static inline __attribute__ ((always_inline)) void IfxVadc_Adc_configureWaitForReadMode(IfxVadc_Adc_Channel *channel, unsigned char waitForRead);
# 863 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
static inline __attribute__ ((always_inline)) Ifx_VADC_RES IfxVadc_Adc_getResult(IfxVadc_Adc_Channel *channel);
# 877 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
...
# 894 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
extern IfxVadc_Status IfxVadc_Adc_initChannel(IfxVadc_Adc_Channel *channel, const IfxVadc_Adc_ChannelConfig *config);
# 904 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
extern void IfxVadc_Adc_initChannelConfig(IfxVadc_Adc_ChannelConfig *config, const IfxVadc_Adc_Group *group);
# 923 "0_Src/4_McHal/Tricore/Vadc/Adc/IfxVadc_Adc.h"
static inline __attribute__ ((always_inline)) void IfxVadc_Adc_configureWaitForReadModeForGlobalResultRegister(IfxVadc_Adc *vadc, unsigned char waitForRead);
...
static inline __attribute__ ((always_inline)) void IfxVadc_Adc_getModuleConfig(IfxVadc_Adc *vadc, IfxVadc_Adc_Config *config)
{
    ...
    config->converterClock = IfxVadc_getConverterClockType();
}
...
void IfxVadc_Adc_getGroupConfig(IfxVadc_Adc_Group *group, IfxVadc_Adc_GroupConfig *config)
{
    ...
    config->disablePostCalibration = ((IfxVadc_getGlobalConfigValue(vadc)).U >> ((16) + group->groupId)) & 0x1;
}
...
IfxVadc_Status IfxVadc_Adc_initModule(IfxVadc_Adc *vadc, const IfxVadc_Adc_Config *config)
{
    ...
    ((void)0);
    IfxScuCcu_selectAdcClock(config->converterClock);
...
void IfxVadc_Adc_initModuleConfig(IfxVadc_Adc_Config *config, Ifx_VADC *vadc)
{
    ...
    config->converterClock = IfxScuCcu_AdcClockSelection_backup;
...
{
    static uint8 init_done[(8)] = {'\0'};
    static uint16 adc_gain_calib[(8)] = {'\0'};
    static sint8 adc_offset_calib[(8)] = {'\0'};
    uint32 AdcQMR_save;
    ...
    uint32 saved_ch0, saved_ch1;

    Ifx_VADC *pIfx_VADC;

    pIfx_VADC = &((*(Ifx_VADC *)0xF0020000u));

    uint32 groupsPerShs = ((8) / (2));


    if (init_done[groupId] == 0)
    {

        adc_offset_calib[groupId] = 0;

        adc_gain_calib[groupId] = 0x3FFF;
    ...
    AdcQMR_save = pIfx_VADC->G[groupId].QMR0.U;

    saved_ch0 = pIfx_VADC->G[groupId].CHCTR[0].U;


    pIfx_VADC->G[groupId].CHCTR[0].U = 0;


    saved_ch1 = pIfx_VADC->G[groupId].CHCTR[1].U;


    pIfx_VADC->G[groupId].CHCTR[1].U = 0;


    while (count--)
    {

        pIfx_VADC->G[groupId].ALIAS.U = 0x1F1E;

        pIfx_VADC->G[groupId].QINR0.U = (1 << 7) | (0x1f & 0);

        pIfx_VADC->G[groupId].QMR0.U = (1 << 16) | (1 << 9) | 0x1;
        ...
        do
        {
            result.U = pIfx_VADC->G[groupId].RES[0].U;
        } while (!result.B.VF);
        ...
        if ((result.B.RESULT > 0) && (adc_offset_calib[groupId] < 63))
        {
            adc_offset_calib[groupId]++;
        }
        else
        {
            if ((result.B.RESULT == 0) && (adc_offset_calib[groupId] > -60))
            {
                adc_offset_calib[groupId]--;
            }
        }
        ...
        {
            volatile uint32 *pointer = (volatile uint32 *)0xF00250E0 + (4 * (groupId % groupsPerShs) + 0x200 * (groupId / groupsPerShs));
            *pointer |= 1 << 31;
        }



        pIfx_VADC->G[groupId].QINR0.U = (1 << 7) | (0x1f & 1);
        ...
        if ((result.B.RESULT < 0xFFF) && (adc_gain_calib[groupId] > 0))
        {


            if (init_done[groupId] == 0)
            {
                adc_gain_calib[groupId] -= 0xFFF - result.B.RESULT;
            }
            else
            {
                adc_gain_calib[groupId]--;
            }
        }
        else
        {
            if ((result.B.RESULT >= 0xFFF) && (adc_gain_calib[groupId] < 0x3FFF))
            {
                adc_gain_calib[groupId]++;
            }
        }
        ...
        pIfx_VADC->SHS[groupId / groupsPerShs].CALGC[groupId % groupsPerShs].U = adc_gain_calib[groupId] | (1 << 15);

        pIfx_VADC->G[groupId].ALIAS.U = 0x0100;
    ...
    pIfx_VADC->G[groupId].QMR0.U = AdcQMR_save;

    pIfx_VADC->G[groupId].CHCTR[0].U = saved_ch0;

    pIfx_VADC->G[groupId].CHCTR[1].U = saved_ch1;
