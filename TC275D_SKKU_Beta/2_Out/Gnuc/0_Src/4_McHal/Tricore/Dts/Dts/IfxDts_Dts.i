...
static inline __attribute__ ((always_inline)) unsigned char IfxDts_isBusy(void);
# 97 "./0_Src/4_McHal/Tricore/Dts/Std/IfxDts.h"
extern unsigned char IfxDts_isReady(void);
...
typedef struct
{
    unsigned char sensorControlDisabled;
    ...
    unsigned char enableSecureLock;
} IfxDts_Dts_Config;
...
static inline __attribute__ ((always_inline)) unsigned char IfxDts_Dts_isBusy(void);
