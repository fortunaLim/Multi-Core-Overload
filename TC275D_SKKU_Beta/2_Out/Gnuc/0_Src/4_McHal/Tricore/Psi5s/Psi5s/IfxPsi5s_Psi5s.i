# 1 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.c"
# 29 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.c"
# 1 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h" 1
# 149 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
# 1 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h" 1
# 43 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h"
# 1 "./0_Src/4_McHal/Tricore/_Impl/IfxPsi5s_cfg.h" 1
# 44 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h" 2
# 1 "./0_Src/4_McHal/Tricore/_PinMap/IfxPsi5s_PinMap.h" 1
# 31 "./0_Src/4_McHal/Tricore/_PinMap/IfxPsi5s_PinMap.h"
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxPsi5s_reg.h" 1
# 36 "./0_Src/4_McHal/Tricore/_Reg/IfxPsi5s_reg.h"
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxPsi5s_regdef.h" 1
# 39 "./0_Src/4_McHal/Tricore/_Reg/IfxPsi5s_regdef.h"
# 1 "./0_Src/4_McHal/Tricore/_Reg/Ifx_TypesReg.h" 1
# 40 "./0_Src/4_McHal/Tricore/_Reg/IfxPsi5s_regdef.h" 2
...
# 1247 "./0_Src/4_McHal/Tricore/_Reg/IfxPsi5s_regdef.h"
...
# 37 "./0_Src/4_McHal/Tricore/_Reg/IfxPsi5s_reg.h" 2
# 32 "./0_Src/4_McHal/Tricore/_PinMap/IfxPsi5s_PinMap.h" 2
...
# 34 "./0_Src/4_McHal/Tricore/_PinMap/IfxPsi5s_PinMap.h" 2
...
# 79 "./0_Src/4_McHal/Tricore/_PinMap/IfxPsi5s_PinMap.h"
...
# 45 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h" 2

# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxPsi5s_bf.h" 1
# 47 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h" 2
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxPsi5s_reg.h" 1
# 48 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h" 2
...
# 49 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h" 2
...
# 50 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h" 2
# 59 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h"
typedef enum
{
...
# 283 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h"
...
# 322 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h"
...
static inline __attribute__ ((always_inline)) void IfxPsi5s_initRxPin(const IfxPsi5s_Rx_In *rx, IfxPort_InputMode inputMode);
...
# 360 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h"
static inline __attribute__ ((always_inline)) void IfxPsi5s_setSleepMode(Ifx_PSI5S *psi5s, IfxPsi5s_SleepMode mode);
# 370 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h"
extern void IfxPsi5s_resetModule(Ifx_PSI5S *psi5s);
# 383 "./0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.h"
extern unsigned char IfxPsi5s_getReadFrameStatus(Ifx_PSI5S *psi5s, IfxPsi5s_ChannelId channelId);
...
# 150 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h" 2
# 160 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
typedef struct
{
    uint32 frequency;
...
typedef struct
{
    unsigned char parityCheckEnabled;
    unsigned char framingCheckEnabled;
    unsigned char overrunCheckEnabled;
    unsigned char fractionalDividerEnabled;
    unsigned char receiverOddParityEnabled;
    unsigned char loopbackEnabled;
    unsigned char transmitterOddParityEnabled;
...
typedef struct
{
    unsigned char ascOnlyMode;
    unsigned char crcErrorConsideredForRSI;
    unsigned char xcrcErrorConsideredForRSI;
    unsigned char transmitErrorConsideredForRSI;
    unsigned char parityErrorConsideredForRSI;
    unsigned char framingErrorConsideredForRSI;
    unsigned char overrunErrorConsideredForRSI;
    unsigned char receiveBufferErrorConsideredForRSI;
    unsigned char headerErrorConsideredForRSI;
    uint32 idleTime;
...
typedef struct
{
    unsigned char bitStuffControl;
    unsigned char crcGenerationControl;
    unsigned char startSequenceGenerationControl;
...
# 403 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
extern void IfxPsi5s_Psi5s_deInitModule(IfxPsi5s_Psi5s *psi5s);
# 413 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
extern unsigned char IfxPsi5s_Psi5s_initModule(IfxPsi5s_Psi5s *psi5s, const IfxPsi5s_Psi5s_Config *config);
# 423 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
extern void IfxPsi5s_Psi5s_initModuleConfig(IfxPsi5s_Psi5s_Config *config, Ifx_PSI5S *psi5s);
# 441 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
static inline __attribute__ ((always_inline)) void IfxPsi5s_Psi5s_enableAscReceiver(IfxPsi5s_Psi5s *psi5s);
# 452 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
...
# 463 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
...
# 472 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
static inline __attribute__ ((always_inline)) void IfxPsi5s_Psi5s_startAscTransactions(IfxPsi5s_Psi5s *psi5s);
# 486 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
extern unsigned char IfxPsi5s_Psi5s_initChannel(IfxPsi5s_Psi5s_Channel *channel, const IfxPsi5s_Psi5s_ChannelConfig *config);
# 496 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
extern void IfxPsi5s_Psi5s_initChannelConfig(IfxPsi5s_Psi5s_ChannelConfig *config, IfxPsi5s_Psi5s *psi5s);
# 506 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
extern void IfxPsi5s_Psi5s_readFrame(IfxPsi5s_Psi5s_Channel *channel, IfxPsi5s_Psi5s_Frame *frame);
# 516 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
extern unsigned char IfxPsi5s_Psi5s_sendChannelData(IfxPsi5s_Psi5s_Channel *channel, uint32 data);
# 529 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.h"
static inline __attribute__ ((always_inline)) unsigned char IfxPsi5s_Psi5s_getReadFrameStatus(IfxPsi5s_Psi5s *psi5s, IfxPsi5s_ChannelId channelId);
...
# 30 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.c" 2
# 42 "0_Src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.c"
...
unsigned char IfxPsi5s_Psi5s_initChannel(IfxPsi5s_Psi5s_Channel *channel, const IfxPsi5s_Psi5s_ChannelConfig *config)
{
...
unsigned char IfxPsi5s_Psi5s_initModule(IfxPsi5s_Psi5s *psi5s, const IfxPsi5s_Psi5s_Config *config)
{
    unsigned char status = 1;
...
void IfxPsi5s_Psi5s_initModuleConfig(IfxPsi5s_Psi5s_Config *config, Ifx_PSI5S *psi5s)
{
    ...
    config->ascConfig.loopbackEnabled = 0;
...
void IfxPsi5s_Psi5s_readFrame(IfxPsi5s_Psi5s_Channel *channel, IfxPsi5s_Psi5s_Frame *frame)
{
    ...
    channel->module->psi5s->INTCLR[channel->channelId].U |= ((0x1) << (1)) | ((0x1) << (0));
}
...
unsigned char IfxPsi5s_Psi5s_sendChannelData(IfxPsi5s_Psi5s_Channel *channel, uint32 data)
{
