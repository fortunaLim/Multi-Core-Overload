# 1 "0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.c"
# 29 "0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.c"
...
# 30 "0_Src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.c" 2
...
{
    uint32 enableChannels = ((((psi5s->GCR.U >> (8)) & ~mask) | channels) << (8));
...
{
    uint32 enableChannels = ((((psi5s->GCR.U >> (16)) & ~mask) | channels) << (16));
...
unsigned char IfxPsi5s_getReadFrameStatus(Ifx_PSI5S *psi5s, IfxPsi5s_ChannelId channelId)
{
