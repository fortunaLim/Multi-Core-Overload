# 1 "0_Src/4_McHal/Tricore/Cpu/CStart/IfxCpu_CStart2.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Cpu/CStart/IfxCpu_CStart2.c"
# 28 "0_Src/4_McHal/Tricore/Cpu/CStart/IfxCpu_CStart2.c"
# 1 "./0_Src/0_AppSw/Config/Common/Ifx_Cfg.h" 1
# 29 "0_Src/4_McHal/Tricore/Cpu/CStart/IfxCpu_CStart2.c" 2
...
# 31 "0_Src/4_McHal/Tricore/Cpu/CStart/IfxCpu_CStart2.c" 2
...
# 32 "0_Src/4_McHal/Tricore/Cpu/CStart/IfxCpu_CStart2.c" 2
...
# 33 "0_Src/4_McHal/Tricore/Cpu/CStart/IfxCpu_CStart2.c" 2
# 51 "0_Src/4_McHal/Tricore/Cpu/CStart/IfxCpu_CStart2.c"
...
# 67 "0_Src/4_McHal/Tricore/Cpu/CStart/IfxCpu_CStart2.c"
void _Core2_start(void)
{
    uint32 pcxi;
    ...
    { uint32 reg_val= (uint32)__USTACK2; asm volatile (" mov.a\t %%""sp"",%0"::"d"(reg_val)); };
    __dsync();
    ...
    do { unsigned __newval = (unsigned) ((uint32)((unsigned int)__INTTAB_CPU2 | (unsigned int)0x1FE0)); __asm__ volatile ("mtcr LO:" "0xFE20" ", %0" :: "d" (__newval) : "memory"); } while (0);
