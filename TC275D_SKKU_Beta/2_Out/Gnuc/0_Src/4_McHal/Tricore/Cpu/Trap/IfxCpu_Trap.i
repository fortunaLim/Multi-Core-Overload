...
# 236 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.c"
void IfxCpu_Trap_vectorTable1(void)
{
    ...
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_busError)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_assertion)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_systemCall_Cpu1)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_nonMaskableInterrupt)); __asm("rfe"); };
}
...
# 264 "0_Src/4_McHal/Tricore/Cpu/Trap/IfxCpu_Trap.c"
void IfxCpu_Trap_vectorTable2(void)
{
    ...
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_busError)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_assertion)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_systemCall_Cpu2)); __asm("rfe"); };
    { __asm(" .align 5");; __asm("mov\t %d4, %d15"); __asm("ji\t %0" : : "a" (IfxCpu_Trap_nonMaskableInterrupt)); __asm("rfe"); };
}
