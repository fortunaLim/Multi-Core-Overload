# 1 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.c"
# 29 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.c"
# 1 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.h" 1
# 43 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.h"
...
# 44 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.h" 2
...
# 30 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.c" 2
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxGtm_bf.h" 1
# 31 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.c" 2
# 53 "0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.c"
...
void IfxGtm_Atom_Agc_enableChannels(Ifx_GTM_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, unsigned char immediate)
{
    uint32 value;



    value = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, (0));
...
void IfxGtm_Atom_Agc_enableChannelsOutput(Ifx_GTM_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, unsigned char immediate)
{
    uint32 value;
...
{
    agc->INT_TRIG.U = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, (0));
}


void IfxGtm_Atom_Agc_enableChannelsUpdate(Ifx_GTM_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask)
{
    agc->GLB_CTRL.U = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, (16));
}


void IfxGtm_Atom_Agc_enableTimeTrigger(Ifx_GTM_ATOM_AGC *agc, unsigned char enabled)
{
...
void IfxGtm_Atom_Agc_setChannelsForceUpdate(Ifx_GTM_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, uint16 resetEnableMask, uint16 resetDisableMask)
{
    ...
    regEnable = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, (0));
    regReset =
        IfxGtm_Atom_Agc_buildFeature(resetEnableMask, resetDisableMask, (16));
...
unsigned char IfxGtm_Atom_Ch_getOutputLevel(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel)
{
...
unsigned char IfxGtm_Atom_Ch_isOneNotification(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel)
{
    unsigned char result;
    Ifx_GTM_ATOM_CH *atomCh = (Ifx_GTM_ATOM_CH *)((uint32)&atom->CH0.RDADDR.U + 0x80 * channel);
...
unsigned char IfxGtm_Atom_Ch_isZeroNotification(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel)
{
    unsigned char result;
    Ifx_GTM_ATOM_CH *atomCh = (Ifx_GTM_ATOM_CH *)((uint32)&atom->CH0.RDADDR.U + 0x80 * channel);
...
void IfxGtm_Atom_Ch_setNotification(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_IrqMode mode, unsigned char interruptOnCompareZero, unsigned char interruptOnCompareOne)
{
    Ifx_GTM_ATOM_CH *atomCh = (Ifx_GTM_ATOM_CH *)((uint32)&atom->CH0.RDADDR.U + 0x80 * channel);
...
void IfxGtm_Atom_Ch_setOneShotMode(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel, unsigned char enabled)
{
    Ifx_GTM_ATOM_CH *atomCh = (Ifx_GTM_ATOM_CH *)((uint32)&atom->CH0.RDADDR.U + 0x80 * channel);
