# 1 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c"
# 29 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c"
# 1 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h" 1
# 80 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
...
typedef unsigned char (*IfxStdIf_Timer_SetFrequency)(IfxStdIf_InterfaceDriver driver, float32 frequency);
...
typedef unsigned char (*IfxStdIf_Timer_SetPeriod)(IfxStdIf_InterfaceDriver driver, Ifx_TimerValue period);
# 186 "./0_Src/1_SrvSw/StdIf/IfxStdIf_Timer.h"
typedef void (*IfxStdIf_Timer_SetSingleMode)(IfxStdIf_InterfaceDriver driver, unsigned char enabled);
...
typedef unsigned char (*IfxStdIf_Timer_AckTimerIrq)(IfxStdIf_InterfaceDriver driver);





typedef unsigned char (*IfxStdIf_Timer_AckTriggerIrq)(IfxStdIf_InterfaceDriver driver);
...
typedef struct
{
    ...
    unsigned char risingEdgeAtPeriod;
    unsigned char outputEnabled;
...
static inline __attribute__ ((always_inline)) unsigned char IfxStdIf_Timer_setFrequency(IfxStdIf_Timer *stdIf, float32 frequency)
{
...
static inline __attribute__ ((always_inline)) unsigned char IfxStdIf_Timer_setPeriod(IfxStdIf_Timer *stdIf, Ifx_TimerValue period)
{
...
static inline __attribute__ ((always_inline)) void IfxStdIf_Timer_setSingleMode(IfxStdIf_Timer *stdIf, unsigned char enabled)
{
...
static inline __attribute__ ((always_inline)) unsigned char IfxStdIf_Timer_ackTimerIrq(IfxStdIf_Timer *stdIf)
{
...
static inline __attribute__ ((always_inline)) unsigned char IfxStdIf_Timer_ackTriggerIrq(IfxStdIf_Timer *stdIf)
{
...
typedef unsigned char (*IfxStdIf_PwmHl_SetDeadtime)(IfxStdIf_InterfaceDriver driver, float32 deadtime);
...
typedef unsigned char (*IfxStdIf_PwmHl_SetMinPulse)(IfxStdIf_InterfaceDriver driver, float32 minPulse);
...
typedef unsigned char (*IfxStdIf_PwmHl_SetMode)(IfxStdIf_InterfaceDriver driver, Ifx_Pwm_Mode mode);
...
typedef void (*IfxStdIf_PwmHl_SetupChannels)(IfxStdIf_InterfaceDriver driver, unsigned char *activeCh, unsigned char *stuckSt);
...
typedef struct
{
    ...
    float32 minPulse;
    uint8 channelCount;
    unsigned char emergencyEnabled;
...
static inline __attribute__ ((always_inline)) unsigned char IfxStdIf_PwmHl_setDeadtime(IfxStdIf_PwmHl *stdIf, float32 deadtime)
{
...
static inline __attribute__ ((always_inline)) unsigned char IfxStdIf_PwmHl_setMinPulse(IfxStdIf_PwmHl *stdIf, float32 minPulse)
{
...
static inline __attribute__ ((always_inline)) unsigned char IfxStdIf_PwmHl_setMode(IfxStdIf_PwmHl *stdIf, Ifx_Pwm_Mode mode)
{
...
static inline __attribute__ ((always_inline)) void IfxStdIf_PwmHl_setupChannels(IfxStdIf_PwmHl *driver, unsigned char *activeCh, unsigned char *stuckSt)
{}
...
# 245 "./0_Src/1_SrvSw/StdIf/IfxStdIf_PwmHl.h"
extern void IfxStdIf_PwmHl_initConfig(IfxStdIf_PwmHl_Config *config);
# 81 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h" 2
# 1 "./0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h" 1
# 73 "./0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
...
static inline __attribute__ ((always_inline)) unsigned char IfxGtm_isEnabled(Ifx_GTM *gtm);
...
extern float32 IfxGtm_Cmu_getClkFrequency(Ifx_GTM *gtm, IfxGtm_Cmu_Clk clkIndex, unsigned char assumeEnabled);
...
extern float32 IfxGtm_Cmu_getEclkFrequency(Ifx_GTM *gtm, IfxGtm_Cmu_Eclk clkIndex, unsigned char assumeEnabled);
...
extern float32 IfxGtm_Cmu_getFxClkFrequency(Ifx_GTM *gtm, IfxGtm_Cmu_Fxclk clkIndex, unsigned char assumeEnabled);
...
extern unsigned char IfxGtm_Cmu_isClkClockEnabled(Ifx_GTM *gtm, IfxGtm_Cmu_Clk clkIndex);
...
extern unsigned char IfxGtm_Cmu_isEclkClockEnabled(Ifx_GTM *gtm, IfxGtm_Cmu_Eclk clkIndex);





extern unsigned char IfxGtm_Cmu_isFxClockEnabled(Ifx_GTM *gtm);
# 157 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Cmu.h"
extern void IfxGtm_Cmu_selectClkInput(Ifx_GTM *gtm, IfxGtm_Cmu_Clk clkIndex, unsigned char useGlobal);
...
# 113 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.h"
...
extern unsigned char IfxGtm_Atom_Ch_getOutputLevel(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel);
...
extern unsigned char IfxGtm_Atom_Ch_isOneNotification(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel);
...
extern unsigned char IfxGtm_Atom_Ch_isZeroNotification(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel);
...
# 223 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.h"
...
# 248 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.h"
...
# 282 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.h"
extern void IfxGtm_Atom_Ch_setNotification(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_IrqMode mode, unsigned char interruptOnCompareZero, unsigned char interruptOnCompareOne);
...
extern void IfxGtm_Atom_Ch_setOneShotMode(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel, unsigned char enabled);
...
# 332 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.h"
extern void IfxGtm_Atom_Agc_enableChannels(Ifx_GTM_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, unsigned char immediate);
# 341 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.h"
extern void IfxGtm_Atom_Agc_enableChannelsOutput(Ifx_GTM_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, unsigned char immediate);
...
extern void IfxGtm_Atom_Agc_enableTimeTrigger(Ifx_GTM_ATOM_AGC *agc, unsigned char enabled);
...
# 381 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Atom.h"
...
# 98 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tom.h"
static inline __attribute__ ((always_inline)) void IfxGtm_Tom_Ch_setCompareShadow(Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel, uint32 shadowZero, uint32 shadowOne);
# 109 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tom.h"
...
extern unsigned char IfxGtm_Tom_Ch_getOutputLevel(Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel);
...
extern unsigned char IfxGtm_Tom_Ch_isOneNotification(Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel);
...
extern unsigned char IfxGtm_Tom_Ch_isZeroNotification(Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel);
...
# 233 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tom.h"
...
extern void IfxGtm_Tom_Ch_setGatedCounter(Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel, unsigned char enabled);
# 291 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tom.h"
extern void IfxGtm_Tom_Ch_setNotification(Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel, IfxGtm_IrqMode mode, unsigned char interruptOnCompareZero, unsigned char interruptOnCompareOne);
...
extern void IfxGtm_Tom_Ch_setOneShotMode(Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel, unsigned char enabled);
...
extern void IfxGtm_Tom_Ch_setPcm(Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel, unsigned char enabled);
...
extern void IfxGtm_Tom_Ch_setSpe(Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel, unsigned char enabled);
...
# 355 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tom.h"
static inline __attribute__ ((always_inline)) void IfxGtm_Tom_Tgc_writeGlobalControl(Ifx_GTM_TOM_TGC *tgc, uint32 control);
# 367 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tom.h"
extern uint32 IfxGtm_Tom_Tgc_buildFeature(uint16 enableMask, uint16 disableMask, uint8 bitfieldOffset);
# 376 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tom.h"
extern void IfxGtm_Tom_Tgc_enableChannels(Ifx_GTM_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask, unsigned char immediate);
# 385 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tom.h"
extern void IfxGtm_Tom_Tgc_enableChannelsOutput(Ifx_GTM_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask, unsigned char immediate);
...
extern void IfxGtm_Tom_Tgc_enableTimeTrigger(Ifx_GTM_TOM_TGC *tgc, unsigned char enabled);
...
# 425 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Tom.h"
...
# 74 "./0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h" 2

# 1 "./0_Src/4_McHal/Tricore/Gtm/Std/IfxGtm_Cmu.h" 1
# 76 "./0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h" 2
# 1 "./0_Src/1_SrvSw/StdIf/IfxStdIf_Timer.h" 1
# 77 "./0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h" 2
# 86 "./0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
typedef struct
{
    Ifx_TimerValue period;
    unsigned char triggerEnabled;
    float32 clockFreq;
    IfxStdIf_Timer_CountDir countDir;
...
# 141 "./0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
extern unsigned char IfxGtm_Atom_Timer_acknowledgeTimerIrq(IfxGtm_Atom_Timer *driver);
...
extern unsigned char IfxGtm_Atom_Timer_acknowledgeTriggerIrq(IfxGtm_Atom_Timer *driver);
...
extern unsigned char IfxGtm_Atom_Timer_setFrequency(IfxGtm_Atom_Timer *driver, float32 frequency);
...
extern unsigned char IfxGtm_Atom_Timer_setPeriod(IfxGtm_Atom_Timer *driver, Ifx_TimerValue period);
...
extern void IfxGtm_Atom_Timer_setSingleMode(IfxGtm_Atom_Timer *driver, unsigned char enabled);
...
extern unsigned char IfxGtm_Atom_Timer_stdIfTimerInit(IfxStdIf_Timer *stdif, IfxGtm_Atom_Timer *driver);
...
# 274 "./0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
extern void IfxGtm_Atom_Timer_addToChannelMask(IfxGtm_Atom_Timer *driver, uint16 mask);
...
extern unsigned char IfxGtm_Atom_Timer_init(IfxGtm_Atom_Timer *driver, const IfxGtm_Atom_Timer_Config *config);
...
# 82 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h" 2
# 95 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
...
# 107 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
typedef struct
{
...
# 173 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
extern unsigned char IfxGtm_Atom_PwmHl_init(IfxGtm_Atom_PwmHl *driver, const IfxGtm_Atom_PwmHl_Config *config);
...
# 195 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
...
extern unsigned char IfxGtm_Atom_PwmHl_setDeadtime(IfxGtm_Atom_PwmHl *driver, float32 deadtime);
...
extern unsigned char IfxGtm_Atom_PwmHl_setMinPulse(IfxGtm_Atom_PwmHl *driver, float32 minPulse);
...
extern unsigned char IfxGtm_Atom_PwmHl_setMode(IfxGtm_Atom_PwmHl *driver, Ifx_Pwm_Mode mode);
...
# 250 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
extern void IfxGtm_Atom_PwmHl_setupChannels(IfxGtm_Atom_PwmHl *driver, unsigned char *activeCh, unsigned char *stuckSt);
...
extern unsigned char IfxGtm_Atom_PwmHl_stdIfPwmHlInit(IfxStdIf_PwmHl *stdif, IfxGtm_Atom_PwmHl *driver);
# 30 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c" 2
# 1 "./0_Src/1_SrvSw/_Utilities/Ifx_Assert.h" 1
# 31 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c" 2
# 1 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\lib\\gcc\\tricore\\4.9.4\\include\\stddef.h" 1 3 4
# 32 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c" 2
# 43 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c"
...
# 54 "0_Src/4_McHal/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c"
...
static const IfxGtm_Atom_PwmHl_Mode IfxGtm_Atom_PwmHl_modes[5] = {
    {0, &IfxGtm_Atom_PwmHl_updateCenterAligned},
    {1, &IfxGtm_Atom_PwmHl_updateCenterAligned},
    {0, &IfxGtm_Atom_PwmHl_updateEdgeAligned },
    {1, &IfxGtm_Atom_PwmHl_updateEdgeAligned },
    {0, &IfxGtm_Atom_PwmHl_updateOff }
};
...
unsigned char IfxGtm_Atom_PwmHl_init(IfxGtm_Atom_PwmHl *driver, const IfxGtm_Atom_PwmHl_Config *config)
{
...
unsigned char IfxGtm_Atom_PwmHl_setDeadtime(IfxGtm_Atom_PwmHl *driver, float32 deadtime)
{
...
unsigned char IfxGtm_Atom_PwmHl_setMinPulse(IfxGtm_Atom_PwmHl *driver, float32 minPulse)
{
...
unsigned char IfxGtm_Atom_PwmHl_setMode(IfxGtm_Atom_PwmHl *driver, Ifx_Pwm_Mode mode)
{
    unsigned char result = 1;
...
void IfxGtm_Atom_PwmHl_setupChannels(IfxGtm_Atom_PwmHl *driver, unsigned char *activeCh, unsigned char *stuckSt)
{

}


unsigned char IfxGtm_Atom_PwmHl_stdIfPwmHlInit(IfxStdIf_PwmHl *stdif, IfxGtm_Atom_PwmHl *driver)
{
