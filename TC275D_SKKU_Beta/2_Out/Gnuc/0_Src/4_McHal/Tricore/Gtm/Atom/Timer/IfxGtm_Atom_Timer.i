# 1 "0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c"
# 29 "0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c"
...
# 43 "./0_Src/4_McHal/Tricore/_Reg/IfxGtm_regdef.h"
# 1 "./0_Src/4_McHal/Tricore/_Reg/Ifx_TypesReg.h" 1
# 44 "./0_Src/4_McHal/Tricore/_Reg/IfxGtm_regdef.h" 2
...
# 51 "./0_Src/4_McHal/Tricore/_Impl/IfxGtm_cfg.h" 2
...
# 30 "0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c" 2
# 1 "./0_Src/1_SrvSw/_Utilities/Ifx_Assert.h" 1
# 31 "0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c" 2
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxGtm_bf.h" 1
# 32 "0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c" 2
# 1 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\lib\\gcc\\tricore\\4.9.4\\include\\stddef.h" 1 3 4
# 33 "0_Src/4_McHal/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c" 2





unsigned char IfxGtm_Atom_Timer_acknowledgeTimerIrq(IfxGtm_Atom_Timer *driver)
{
    unsigned char event;
...
unsigned char IfxGtm_Atom_Timer_acknowledgeTriggerIrq(IfxGtm_Atom_Timer *driver)
{
    unsigned char event;
...
unsigned char IfxGtm_Atom_Timer_init(IfxGtm_Atom_Timer *driver, const IfxGtm_Atom_Timer_Config *config)
{
...
void IfxGtm_Atom_Timer_initConfig1(IfxGtm_Atom_Timer_Config *config, Ifx_GTM *gtm)
{
     IfxStdIf_Timer_initConfig1(&config->base);
    config->gtm = gtm;
    config->atom = IfxGtm_Atom_0;
    config->timerChannel = IfxGtm_Atom_Ch_0;
    config->triggerOut = ((void *)0);
...
unsigned char IfxGtm_Atom_Timer_setFrequency(IfxGtm_Atom_Timer *driver, float32 frequency)
{
...
unsigned char IfxGtm_Atom_Timer_setPeriod(IfxGtm_Atom_Timer *driver, Ifx_TimerValue period)
{
...
void IfxGtm_Atom_Timer_setSingleMode(IfxGtm_Atom_Timer *driver, unsigned char enabled)
{
...
unsigned char IfxGtm_Atom_Timer_stdIfTimerInit(IfxStdIf_Timer *stdif, IfxGtm_Atom_Timer *driver)
{
