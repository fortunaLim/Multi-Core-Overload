...
# 160 "0_Src/4_McHal/Tricore/Gtm/Trig/IfxGtm_Trig.h"
...
boolean IfxGtm_Trig_fromDsadc(Ifx_GTM *gtm, uint32 dsadcChannel, IfxGtm_Tim tim, IfxGtm_Tim_Ch timChannel)
{
    ...
    result &= (((timChannel) >= (IfxGtm_Tim_Ch_0)) && ((timChannel) <= (IfxGtm_Tim_Ch_5)));
