...
void IfxAsclin_enableAscErrorFlags(Ifx_ASCLIN *asclin, unsigned char parEnable, unsigned char rfoEnable)
{
...
unsigned char IfxAsclin_setBitTiming(Ifx_ASCLIN *asclin, float32 baudrate, IfxAsclin_OversamplingFactor oversampling, IfxAsclin_SamplePointPosition samplepoint, IfxAsclin_SamplesPerBit medianFilter)
{
