# 1 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.c"
# 30 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.c"
# 1 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h" 1
# 373 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h"
# 1 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h" 1
# 42 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
# 1 "./0_Src/4_McHal/Tricore/_Impl/IfxHssl_cfg.h" 1
# 43 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h" 2
...
# 44 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h" 2
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxHssl_reg.h" 1
# 36 "./0_Src/4_McHal/Tricore/_Reg/IfxHssl_reg.h"
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxHssl_regdef.h" 1
# 39 "./0_Src/4_McHal/Tricore/_Reg/IfxHssl_regdef.h"
# 1 "./0_Src/4_McHal/Tricore/_Reg/Ifx_TypesReg.h" 1
# 40 "./0_Src/4_McHal/Tricore/_Reg/IfxHssl_regdef.h" 2
...
# 785 "./0_Src/4_McHal/Tricore/_Reg/IfxHssl_regdef.h"
...
# 834 "./0_Src/4_McHal/Tricore/_Reg/IfxHssl_regdef.h"
...
# 37 "./0_Src/4_McHal/Tricore/_Reg/IfxHssl_reg.h" 2
# 45 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h" 2
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxHsct_reg.h" 1
# 36 "./0_Src/4_McHal/Tricore/_Reg/IfxHsct_reg.h"
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxHsct_regdef.h" 1
# 45 "./0_Src/4_McHal/Tricore/_Reg/IfxHsct_regdef.h"
...
# 568 "./0_Src/4_McHal/Tricore/_Reg/IfxHsct_regdef.h"
...
# 37 "./0_Src/4_McHal/Tricore/_Reg/IfxHsct_reg.h" 2
# 46 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h" 2
...
# 47 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h" 2
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxHssl_bf.h" 1
# 48 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h" 2
# 1 "./0_Src/4_McHal/Tricore/_Reg/IfxHsct_bf.h" 1
# 49 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h" 2
...
# 50 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h" 2
# 59 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
typedef enum
{
    IfxHssl_ChannelId_0,
    IfxHssl_ChannelId_1,
...
typedef enum
{
    IfxHssl_Hsct_InterruptSource_headerError = (1),
    IfxHssl_Hsct_InterruptSource_payloadError = (2),
    IfxHssl_Hsct_InterruptSource_commandError = (3),
    IfxHssl_Hsct_InterruptSource_interfaceControlFrameSend = (4),
    IfxHssl_Hsct_InterruptSource_speedModeSwitchError = (5),
    IfxHssl_Hsct_InterruptSource_unsolicitedMessageSendFinished = (6),
    IfxHssl_Hsct_InterruptSource_pllLockLosterror = (7),
    IfxHssl_Hsct_InterruptSource_UnsolicitedMessageReceived = (8),
    IfxHssl_Hsct_InterruptSource_pingAnswerReceived = (9),
    IfxHssl_Hsct_InterruptSource_txTransferError = (10),

    IfxHssl_Hsct_InterruptSource_synchronizationFifoOverflow = (11),

    IfxHssl_Hsct_InterruptSource_synchronizationFifoUnderflow = (12)
...
typedef enum
{
    IfxHssl_Hssl_ERRInterruptSource_notAcknowledgeError = (0),
    IfxHssl_Hssl_ERRInterruptSource_transactionTagError = (4),
    IfxHssl_Hssl_ERRInterruptSource_timeoutError = (8),
    IfxHssl_Hssl_ERRInterruptSource_unexpectedError = (12)
...
typedef enum
{
    IfxHssl_Hssl_EXIInterruptSource_memoryAccessViolation = (21),
    IfxHssl_Hssl_EXIInterruptSource_busAccessError = (22),
    IfxHssl_Hssl_EXIInterruptSource_channelNumberCodeError = (23),

    IfxHssl_Hssl_EXIInterruptSource_dataLengthError = (24),
    IfxHssl_Hssl_EXIInterruptSource_crcError = (25)
} IfxHssl_Hssl_EXIInterruptSource;
# 236 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
typedef struct
{
    Ifx_HSCT *hsct;
} IfxHssl_Hsct;
...
# 264 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
...
static inline __attribute__ ((always_inline)) unsigned char IfxHssl_getHsctInterruptFlagStatus(Ifx_HSCT *hsct, IfxHssl_Hsct_InterruptSource source);
...
# 310 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
...
# 333 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
...
static inline __attribute__ ((always_inline)) void IfxHssl_clearHsslGlobalErrorInterruptFlag(Ifx_HSSL *hssl, IfxHssl_Hssl_ERRInterruptSource source);
...
static inline __attribute__ ((always_inline)) void IfxHssl_disableHsslGlobalErrorInterruptFlag(Ifx_HSSL *hssl, IfxHssl_Hssl_ERRInterruptSource source);
# 364 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
...
# 381 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
...
static inline __attribute__ ((always_inline)) void IfxHssl_enableHsslGlobalErrorInterruptFlag(Ifx_HSSL *hssl, IfxHssl_Hssl_ERRInterruptSource source);
# 405 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
...
# 414 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
...
static inline __attribute__ ((always_inline)) unsigned char IfxHssl_getHsslChannelErrorInterruptFlagStatus(Ifx_HSSL *hssl, IfxHssl_Hssl_ERRInterruptSource source, IfxHssl_ChannelId channelId);
...
static inline __attribute__ ((always_inline)) unsigned char IfxHssl_getHsslGloabalErrorInterruptFlagStatus(Ifx_HSSL *hssl, IfxHssl_Hssl_EXIInterruptSource source);
...
# 446 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
...
# 498 "./0_Src/4_McHal/Tricore/Hssl/Std/IfxHssl.h"
...
# 374 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h" 2
...
# 375 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h" 2
# 384 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h"
typedef enum
{
...
# 412 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h"
typedef struct
{
    uint32 start;
    uint32 end;
...
# 626 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h"
extern IfxHssl_Hssl_Status IfxHssl_Hssl_waitAcknowledge(IfxHssl_Hssl_Channel *channel);
# 638 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h"
...
# 653 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h"
...
# 685 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h"
...
# 697 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.h"
...
# 31 "0_Src/4_McHal/Tricore/Hssl/Hssl/IfxHssl_Hssl.c" 2
