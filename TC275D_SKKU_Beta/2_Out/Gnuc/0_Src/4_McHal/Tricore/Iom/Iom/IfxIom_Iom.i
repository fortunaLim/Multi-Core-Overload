# 1 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.c"
# 1 "D:\\TC275\\eclipse\\workspace\\TC275D_SKKU_Beta//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.c"
# 30 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.c"
# 1 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h" 1
# 133 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
...
# 134 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h" 2
# 143 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
typedef struct
{
    uint32 eventCombinerSelection0 : 1;
    uint32 eventCombinerSelection1 : 1;
    uint32 eventCombinerSelection2 : 1;
    uint32 eventCombinerSelection3 : 1;
    uint32 eventCombinerSelection4 : 1;
    uint32 eventCombinerSelection5 : 1;
    uint32 eventCombinerSelection6 : 1;
    uint32 eventCombinerSelection7 : 1;
    uint32 eventCombinerSelection8 : 1;
    uint32 eventCombinerSelection9 : 1;
    uint32 eventCombinerSelection10 : 1;
    uint32 eventCombinerSelection11 : 1;
    uint32 eventCombinerSelection12 : 1;
    uint32 eventCombinerSelection13 : 1;
    uint32 eventCombinerSelection14 : 1;
    uint32 eventCombinerSelection15 : 1;
    uint32 countedEventCombinerSelection0 : 1;
    uint32 countedEventCombinerSelection1 : 1;
    uint32 countedEventCombinerSelection2 : 1;
    uint32 countedEventCombinerSelection3 : 1;
    uint32 reserved : 12;
...
typedef struct
{
    IfxIom_EventCounterChannel input;
    IfxIom_EventCounterThreshold threshold;
...
typedef struct
{
    ...
    IfxIom_Iom_EcmGlobalEventSelection globalEventSelection;
...
typedef struct
{
    uint16 comparatorThreshold;
    boolean timerReset;
    IfxIom_MonitorSignal monitorSignal;
    IfxIom_ReferenceSignal referenceSignal;
    IfxIom_FilterMode filterMode;
    IfxIom_FpcChannelId channelId;
    IfxIom_EdgeClearType edgeType;
    boolean exorInputEnable[8];
...
{
    IfxIom_LamId lamId;
    uint32 eventWindowThreshold;

    boolean monitorSignalInverted;
    boolean referenceSignalInverted;
    IfxIom_EventSource eventSource;
    IfxIom_LamMonitorInputChannel lamMonitorInputChannel;
    IfxIom_LamReferenceInputChannel lamReferenceInputChannel;
    IfxIom_LamMonitorSource lamMonitorSource;
    IfxIom_LamRunMode lamMode;
    boolean eventWindowInverted;
    IfxIom_EventActiveEdgeSelection eventActiveEdgeSelection;
} IfxIom_Iom_LamConfig;
# 250 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
extern void IfxIom_Iom_deInitModule(IfxIom_Iom *iom);
# 260 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
extern boolean IfxIom_Iom_initAnalyser(IfxIom_Iom *iom, const IfxIom_Iom_LamConfig *lamConfig);
# 269 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
extern void IfxIom_Iom_initAnalyserConfig(IfxIom_Iom_LamConfig *lamConfig);
# 279 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
extern boolean IfxIom_Iom_initCombiner(IfxIom_Iom *iom, const IfxIom_Iom_EcmConfig *ecmConfig);
# 288 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
extern void IfxIom_Iom_initCombinerConfig(IfxIom_Iom_EcmConfig *ecmConfig);
# 298 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
extern boolean IfxIom_Iom_initFpcChannel(IfxIom_Iom *iom, const IfxIom_Iom_FpcConfig *fpcConfig);
# 307 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
extern void IfxIom_Iom_initFpcChannelConfig(IfxIom_Iom_FpcConfig *fpcConfig);
# 316 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
extern boolean IfxIom_Iom_initModule(IfxIom_Iom *iom);
# 326 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
extern void IfxIom_Iom_initModuleConfig(IfxIom_Iom *iom, Ifx_IOM *module);
# 345 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.h"
extern void IfxIom_Iom_clearFpcEdges(IfxIom_Iom_FpcConfig *fpcConfig, IfxIom_Iom *iom);
# 31 "0_Src/4_McHal/Tricore/Iom/Iom/IfxIom_Iom.c" 2
...
void IfxIom_Iom_initFpcChannelConfig(IfxIom_Iom_FpcConfig *fpcConfig)
{
    ...
    fpcConfig->timerReset = 1;
    fpcConfig->edgeType = IfxIom_EdgeClearType_risingFalling;

    for (exorInput = 0; exorInput <= 7; exorInput++)
    {
        fpcConfig->exorInputEnable[exorInput] = 0;
    }
}
